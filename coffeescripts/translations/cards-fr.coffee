...
exportObj.translations['Français'] =
    ...
    slot:
        ...
        "Cargo": "Cargaison"
    sources:
        "First Edition Core Set": "Boîte de base 1.0"
        "First Edition Force Awakens Core Set": "Boîte de base 1.0 Le réveil de la Force"
        "First Edition VT-49 Decimator Expansion Pack": "Paquet d'extension Décimateur VT-49 1.0"
        "First Edition YT-2400 Freighter Expansion Pack": "Paquet d'extension Cargo léger YT-2400 1.0"
        ...
        "Epic Battles Multiplayer Expansion": "Extension Batailles Épiques"
...
exportObj.cardLoaders['Français'] = () ->
    ...
    pilot_translations =
        ...
        "Alpha Squadron Pilot":
           ...
           text: """<i class = flavor_text>Sienar Fleet Systems a doté les ailes de l’intercepteur TIE de quatre canons laser qui lui confèrent une puissance de feu bien supérieure à celle des précédents modèles.</i>"""
        "Anakin Skywalker":
        ...
        "Arvel Crynyd":
           ...
           text: """Si vous deviez échouer à une action %BOOST% qui vous amènerait à chevaucher un autre vaisseau, résolvez-la comme si vous exécutiez partiellement une manœuvre à la place.%LINEBREAK%Tant que vous effectuez une attaque à portée d’attaque 0, considérez-la comme une attaque à portée d’attaque 1. %LINEBREAK%<i>Errata (1.4): Changement par rapport aux nouvelles règles de portée 0.</i>"""
        "Asajj Ventress":
        ...
        "Autopilot Drone":
           ...
           text: """<i class = flavor_text>Il est parfois utile d’ignorer les avertissements de sécurité préconisés par les fabricants…</i>"""
        "BB-8":
           display_name: """BB-8"""
        ...
        "Black Squadron Ace (T-70)":
           display_name: """As de l’Escadron Noir"""
           text: """<i class = flavor_text>Lors de la Guerre Froide, l’Escadron Noir de Poe Dameron entreprit d’audacieuses missions secrètes contre le Premier Ordre, sans tenir compte des traités ratifiés par le Sénat de la Nouvelle République.</i>"""
        "Black Squadron Scout":
           display_name: """Éclaireur de l’Escadron Noir"""
           text: """<i class = flavor_text>Ce vaisseau atmosphérique lourdement armé se sert de ses ailes mobiles pour gagner en vitesse et manœuvrabilité.</i>"""
        "Black Sun Ace":
        ...
        "Black Sun Assassin":
           ...
           text: """<i class = flavor_text>Abattre sa cible au coin d’une ruelle sombre ou ajouter une goutte de poison à une boisson sont des méthodes courantes d’assassinat, mais une navette en feu s’écrasant au sol fait passer un tout autre message.</i>"""
        "Black Sun Enforcer":
           display_name: """Homme de Main du Soleil Noir"""
           text: """<i class = flavor_text>Le prince Xizor en personne collabora avec MandalMotors pour concevoir la plateforme d’attaque de classe StarViper, l’un des plus redoutables chasseurs de la galaxie. </i>"""
        "Black Sun Soldier":
        ...
        "Blue Squadron Recruit":
           ...
           text: """<i class = flavor_text>Toute une génération a grandi avec des récits d’exploits héroïques lors de la Guerre Civile Galactique, et nombreux sont ceux qui ont appris à piloter dans les mêmes cockpits qui avaient accueilli leurs parents dans leur combat contre l’Empire.</i>"""
        "Blue Squadron Rookie":
           display_name: """Pilote débutant de l’Escadron Bleu"""
           text: """<i class = flavor_text>Le X-wing T-70 d’Incom-FreiTek a été conçu pour être plus polyvalent que son prédécesseur, le X-wing T-65. L’emplacement du droïde a été amélioré et permet de recevoir un large éventail d’astromechs, et les points d’emport modulaires permettent au personnel au sol d’adapter l’armement du T-70 en fonction de ses missions.</i>"""
        "Blue Squadron Scout":
        ...
        "Bravo Flight Officer":
           ...
           text: """<i class = flavor_text>Les pilotes volontaires des Forces Royales de Sécurité de Naboo sont déterminés à protéger le peuple et les idéaux de leur monde natal, et font confiance à leur Reine pour les envoyer au combat seulement quand toutes les autres options ont échoué.</i>"""
        "Braylen Stramm":
        ...
        "Captain Oicunn":
           ...
           text: """Tant que vous effectuez une attaque à portée d’attaque 0, considérez-la comme une attaque à portée d’attaque 1. %LINEBREAK%<i>Errata (1.4): Changement lié aux nouvelles règles de portée 0.</i>"""
        "Captain Phasma":
        ...
        "Cartel Executioner":
           ...
           text: """<i class = flavor_text>De nombreux pilotes chevronnés au service des kajidics Hutt et d’autres organisations criminelles utilisent le chasseur M12-L Kimogila à cause de sa puissance de feu et de la peur qu’il inspire.</i>"""
        "Cartel Marauder":
        ...
        "Cartel Spacer":
           ...
           text: """<i class = flavor_text>L’Intercepteur « Scyk » M3-A de MandalMotors est acheté en grande quantité par le Cartel Hutt et les contrebandiers Car’das en raison de son prix bas et de ses nombreuses possibilités de personnalisation.</i>"""
        "Cassian Andor":
        ...
        "Colossus Station Mechanic":
           ...
           text: """<i class = flavor_text>Certains pilotes ambitieux et talentueux commencent leur carrière en tant qu’équipier au sol, travaillant sans relâche pour permettre à des vaisseaux rafistolés de voler dans les cieux de mondes éloignés comme Castilon.</i>"""
        "Commander Malarus":
        ...
        "DBS-404":
           ...
           text: """Tant que vous effectuez une attaque à portée d’attaque 1, vous <b>devez</b> lancer 1 dé supplémentaire. Après que l’attaque a touché, subissez 1 dégât %CRIT%. %LINEBREAK%<i>Errata (1.4): Changement de la portée.</i>"""
        "DFS-081":
        ...
        "Delta Squadron Pilot":
           ...
           text: """<i class = flavor_text>En plus de ses six canons laser et de ses lance-missiles, le redoutable défenseur TIE est équipé d’écrans déflecteurs et d’un hyperdrive.</i>"""
        "Dengar":
           display_name: """Dengar"""
        ...
        "Fenn Rau (Sheathipede)":
           ...
           text: """Avant qu’un vaisseau ennemi situé dans votre arc de tir ne s’engage, si vous n’êtes pas stressé, vous pouvez gagner 1 marqueur de stress. Dans ce cas, ce vaisseau ennemi ne peut pas dépenser de marqueur pour modifier des dés tant qu’il effectue une attaque pendant cette phase. %LINEBREAK% <i>Errata (1.1.0): Remplacement de « Après qu’un vaisseau ennemi situé dans votre arc de tir vous a engagé » par « Avant qu’un vaisseau ennemi situé dans votre arc de tir ne s’engage...»</i>"""
        "Fenn Rau":
           display_name: """Fenn Rau"""
        ...
        "First Order Provocateur":
           ...
           text: """<i class = flavor_text>Les idées du Major Vonreg ont guidé l’amélioration de modèles déjà éprouvés lors de la conception de cet appareil unique en son genre, précis et mortel, par Sienar-Jaemus Fleet Systems.</i>"""
        "First Order Test Pilot":
           display_name: """Pilote d’Essai du Premier Ordre"""
           text: """<i class = flavor_text>Conçu pour la vitesse et particulièrement maniable, le TIE Silencer est un appareil dévastateur entre les mains des pilotes qui savent en tirer tout son potentiel. Des pilotes moins talentueux seraient incapables de maîtriser la vélocité de ce vaisseau.</i>"""
        "Foreman Proach":
        ...
        "Gamma Squadron Ace":
           ...
           text: """<i class = flavor_text>Bien qu’il ne soit pas aussi maniable et rapide qu’un TIE/ln, le Bombardier TIE a une puissance de feu suffisante pour détruire à peu près n’importe quelle cible.</i>"""
        "Gand Findsman":
        ...
        "Green Squadron Expert":
           ...
           text: """<i class = flavor_text>Le RZ-2 intègre en série les modifications apportées au fil des ans à son prédécesseur. Les pilotes les plus audacieux considèrent que la meilleure fiabilité de ce modèle les autorise à repousser encore plus les limites de l’appareil.</i>"""
        "Green Squadron Pilot":
           display_name: """Pilote de l’Escadron Vert"""
           text: """<i class = flavor_text>À cause de ses commandes sensibles et de son extrême manœuvrabilité, seuls les meilleurs pilotes osent prendre place dans le cockpit d’un A-wing.</i>"""
        "Greer Sonnel":
        ...
        "Hera Syndulla (B-Wing)":
           display_name: """Hera Syndulla"""
           text: """Tant qu'un autre vaisseau allié à portée 1-2 défend ou effectue une attaque, vous pouvez transférer 1 de vos marqueurs de concentration, d'évasion ou de verrouillage à ce vaisseau. (faites-le lors d’une étape « Modifier les dés ») %LINEBREAK% <i>Errata (1.3.2): Ajout d’une précision de timing pour indiquer à quel moment précis d’une attaque cette capacité peut être utilisée.</i>"""
        ...
        "Imdaar Test Pilot":
           ...
           text: """<i class = flavor_text>Conçu dans un centre de recherches secret sur Imdaar Alpha, le TIE Fantôme concrétise ce qui semblait impossible : un petit chasseur furtif équipé d’un système d’occultation avancé.</i>"""
        "Inaldra":
        ...
        "Jakku Gunrunner":
           ...
           text: """<i class = flavor_text>Le Remorqueur Spatial de Transfert Quadrimoteur, surnommé « Quad jumper », était aussi manœuvrable sous atmosphère que dans l’espace, ce qui le rendait extrêmement populaire auprès des contrebandiers et des explorateurs. </i>"""
        "Jan Ors":
        ...
        "Jedi Knight":
           ...
           text: """<i class = flavor_text>Lorsque la Guerre des Clones débuta, les chevaliers Jedi rallièrent la cause de la sauvegarde de la République, prenant le commandement de légions composées de soldats clones et les menant au combat.</i>"""
        "Jek Porkins":
        ...
        "Knave Squadron Escort":
           ...
           text: """<i class = flavor_text>Conçu pour combiner les meilleurs atouts de l’A-wing et du X-wing, l’E-wing dispose d’une puissance de feu, d’une vitesse et d’une manœuvrabilité supérieures.</i>"""
        "Koshka Frost":
        ...
        "Lieutenant Dormitz":
           ...
           text: """<strong>Setup</strong>: après vous être placé, les autres vaisseaux alliés peuvent être placés n’importe où dans la zone de jeu à portée 0-2 de vous."""
        "Lieutenant Karsabi":
        ...
        "Lothal Rebel":
           ...
           text: """<i class = flavor_text>Autre réussite commerciale de la Corporation Technique Corellienne, le cargo VCX-100 est plus gros que les légendaires appareils de la série YT, et propose un espace de vie plus volumineux et de meilleures possibilités de personnalisation.</i>"""
        "Lowhhrick":
        ...
        "Mining Guild Surveyor":
           ...
           text: """<i class = flavor_text>Les projets impériaux consommant de plus en plus de matières premières, la Guilde Minière exploite avidement les gisements de minerai de doonium récemment mis au jour sur des planètes telles que Batonn, Lothal ou Umbara.</i>"""
        "Miranda Doni":
        ...
        "Norra Wexley":
           display_name: """Norra Wexley"""
           text: """Tant que vous défendez, si un vaisseau ennemi est à portée 0-1, ajoutez 1 résultat %EVADE% à vos résultats de dés. %LINEBREAK% <i>Errata (1.0.2): Suppression de « vous pouvez ».</i>"""
        "Nu Squadron Pilot":
        ...
        "Omega Squadron Expert":
           ...
           text: """<i class = flavor_text>Le TIE/sf est un appareil polyvalent qui embarque de l’armement spécialisé et des systèmes expérimentaux utilisés lors des opérations à long rayon d’action des Forces spéciales du Premier Ordre.</i>"""
        "Omicron Group Pilot":
        ...
        "Onyx Squadron Ace":
           ...
           text: """<i class = flavor_text>L’appareil expérimental qu’est le défenseur TIE surclasse tous les vaisseaux de sa génération, mais sa taille, sa vitesse et son arsenal augmentent considérablement son coût de fabrication.</i>"""
        "Onyx Squadron Scout":
        ...
        "Petranaki Arena Ace":
           ...
           text: """<i class = flavor_text>L’Arène de Petranaki est un gigantesque édifice de Géonosis qui a été le lieu principal de la première bataille de la Guerre des Clones.</i>"""
        ...
        "Phoenix Squadron Pilot":
           ...
           text: """<i class = flavor_text>Dirigés par le commandant Jun Sato et malgré leur manque d’expérience, les courageux pilotes de l’Escadron Phœnix firent face à des défis complexes dans leur lutte contre l’Empire Galactique.</i>"""
        "Planetary Sentinel":
           display_name: """Sentinelle Planétaire"""
           text: """<i class = flavor_text>Pour protéger ses installations militaires, l’Empire a besoin d’une force de défense rapide et vigilante.</i>"""
        "Plo Koon":
        ...
        "Red Squadron Bomber":
           ...
           text: """<i class = flavor_text>Durant la bataille de Géonosis, l’Escadron Rouge a fourni une couverture indispensable aux canonnières TO/BA déployées pour sécuriser la surface.</i>"""
        "Red Squadron Expert":
           display_name: """Expert de l’Escadron Rouge"""
           text: """<i class = flavor_text>Le Corps des Chasseurs de la Résistance est en grande partie constitué de jeunes volontaires issus de la Nouvelle République, mais aussi de vétérans de la Guerre Civile Galactique déterminés à terminer ce qu’ils ont commencé quelques décennies plus tôt.</i>"""
        ...
        "Rogue Squadron Escort":
           ...
           text: """<i class = flavor_text>Les pilotes d’élite de l’Escadron Rogue font partie des meilleurs pilotes de la Rébellion.</i>"""
        "Ronith Blario":
        ...
        "Saber Squadron Ace":
           ...
           text: """<i class = flavor_text>Dirigés par le Baron Fel Soontir, les pilotes de l’escadron Sabre sont parmi les meilleurs de l’Empire. Leurs Intercepteurs TIE sont marqués avec des bandes rouges pour désigner les pilotes ayant au moins dix victoires confirmées.</i>"""
        "Sabine Wren":
           display_name: """Sabine Wren"""
        ...
        "Scarif Base Pilot":
           ...
           text: """<i class = flavor_text>Le TIE Reaper fut conçu pour déposer des troupes d’élite sur les points chauds des champs de bataille, comme les terrifiants Death Troopers du Directeur Krennic lors de la Bataille de Scarif.</i>"""
        "Scimitar Squadron Pilot":
           display_name: """Scimitar Squadron Pilot"""
           text: """<i class = flavor_text>Le TIE/sa est particulièrement précis pour un bombardier, lui permettant des frappes ciblées tout en évitant d’infliger des dommages collatéraux excessifs à la zone environnante.</i>"""
        "Separatist Bomber":
           display_name: """Bombardier Séparatiste"""
           text: """<i class = flavor_text>Les armées droïdes des Séparatistes sont insensibles à la détresse des civils et ne font aucun effort pour limiter les dommages collatéraux.</i>"""
        "Separatist Drone":
           display_name: """Drone Séparatiste"""
           text: """<i class = flavor_text>Alors que la Guerre des Clones s’intensifie, l’Alliance Séparatiste continue d’améliorer la technologie des chasseurs droïdes, ainsi que les droïdes tactiques qui les dirigent.</i>"""
        "Serissu":
        ...
        "Shadow Squadron Veteran":
           ...
           text: """<i class = flavor_text>l’Escadron Shadow, actif depuis les tout premiers jours de la Guerre des Clones, a remporté des victoires prestigieuses à Kadavo et contre le vaisseau amiral de Grievous, le Malveillance.</i>"""
        "Shadowport Hunter":
        ...
        "Sienar-Jaemus Engineer":
           ...
           text: """<i class = flavor_text>Conçu par Sienar-Jaemus Fleet Systems pour succéder au fameux TIE Defender, le TIE/vn Silencer intègre des technologies de pointe développées par des centres de recherche dissimulés dans les Régions Inconnues.</i>"""
        "Sigma Squadron Ace":
           display_name: """As de l’Escadron Sigma"""
           text: """<i class = flavor_text>Équipé d’un hyperdrive et de boucliers, le TIE Fantôme dispose également de cinq canons laser qui lui confèrent une puissance de feu inouïe pour un chasseur Impérial.</i>"""
        "Skakoan Ace":
        ...
        "Skull Squadron Pilot":
           ...
           text: """<i class = flavor_text>Les as de l’Escadron Skull privilégient une approche agressive, profitant de la technologie d’ailes montées sur pivot de leurs appareils, ce qui leur confère une maniabilité exceptionnelle quand ils poursuivent leurs proies. </i>"""
        "Sol Sixxa":
        ...
        "Stalgasin Hive Guard":
           ...
           text: """<i class = flavor_text>Conçu pour la physiologie spécifique des pilotes Géonosiens, les chasseurs de classe Nantex sont capables de manœuvres qui briseraient la plupart des vaisseaux et des pilotes.</i>"""
        "Starkiller Base Pilot":
           display_name: """Pilote de la Base Starkiller"""
           text: """<i class = flavor_text>La navette de commandement de classe <unitalic>Upsilon</unitalic> sert de base d’opérations pour de nombreux agents et officiers d’élite du Premier Ordre. Ils peuvent facilement semer l’effroi à travers la galaxie grâce à ses équipements de communication et senseurs avancés.</i>"""
        "Storm Squadron Ace":
           display_name: """As de l’Escadron Storm"""
           text: """<i class = flavor_text>Le Tie Advanced x1 a été produit en quantités limitées, mais les ingénieurs de Sienar incorporèrent la plus grande partie de ses innovations dans leur nouveau modèle de TIE : l’Intercepteur TIE.</i>"""
        "Sun Fac":
        ...
        "Tansarii Point Veteran":
           ...
           text: """<i class = flavor_text>La défaite de l’as du Soleil Noir, Talonbane Cobra, abattu par des contrebandiers Car’das, changea le cours de la bataille de la station Tansarii Point. Les survivants de cet affrontement sont respectés dans tout le secteur."""
        "Techno Union Bomber":
           display_name: """Bombardier du Techno-Syndicat"""
           text: """<i class = flavor_text>Les Armureries Baktoid ont développé le Hyena comme un vaisseau d’assaut compatible avec les tactiques de nuée des chasseurs Vulture de la Fédération du Commerce.</i>"""
        "Tel Trevura":
        ...
        "Tempest Squadron Pilot":
           ...
           text: """<i class = flavor_text>Le TIE Advanced est une version améliorée du célèbre chasseur TIE/ln disposant de boucliers, d’un meilleur système d’armement, de panneaux solaires incurvés et d’un hyperdrive.</i>"""
        "Ten Numb":
        ...
        "Trade Federation Drone":
           ...
           text: """<i class = flavor_text>La Fédération du Commerce a déployé d’innombrables droïdes Vulture lors de la Bataille de Naboo, et continue d’utiliser ces chasseurs peu coûteux durant la Guerre des Clones.</i>"""
        "Trandoshan Slaver":
        ...
        "Wild Space Fringer":
           ...
           text: """<i class = flavor_text>Certes, le cargo léger YT-2400 possédait une soute de bonne taille, mais celle-ci était souvent encombrée de systèmes d’armement modifiés et de moteurs énormes.</i>"""
        "Wullffwarro":
        ...
        "Zealous Recruit":
           ...
           text: """<i class = flavor_text>Les pilotes de Chasseur Fang Mandalorien doivent maîtriser la manœuvre dite de l’Opposition Concordia, profitant du profil de leurs appareils pour mener des charges sans concession. </i>"""
        "Zertik Strom":
        ...
        "Zeta Squadron Survivor":
           ...
           text: """<i class = flavor_text>Humiliés par leur défaite, les pilotes rescapés de la base Starkiller sont impatients de démontrer leur talent face aux combattants de la Résistance.</i>"""
        "Zizi Tlo":
        ...
        '"Echo"':
           display_name: """“Echo”"""
           text: """Lorsque vous vous désoccultez, vous <b>devez</b> utiliser le gabarit [2 %BANKLEFT%] ou [2 %BANKRIGHT%] à la place du gabarit [2 %STRAIGHT%]."""
        '"Ember"':
           display_name: """“Ember”"""
        ...
        '"Goji"':
           display_name: """“Goji”"""
           text: """Tant qu’un vaisseau allié à portée 0–3 défend, il peut lancer 1 dé de défense supplémentaire pour chaque bombe alliée à portée 0–1 de lui. %LINEBREAK% <i>Errata (1.1.0): la mention « ...ou mine... » a été retirée</i>"""
        '"Holo"':
           display_name: """“Holo”"""
        ...
        '"Vizier"':
           display_name: """“Vizier”"""
           text: """Après vous être déplacé en utilisant vos <b>Ailerons Contrôlables</b>, vous pouvez effectuer une action %COORDINATE%. Dans ce cas, sautez votre étape “Effectuer une action”. %LINEBREAK%<i>Errata (1.4.31) : Changement de manœuvre par un déplacement.</i>"""
        '"Wampa"':
           display_name: """“Wampa”"""
        ...
        "Commandant Goran":
           text: """Au début de la Phase d'Engagement, choisissez un vaisseau allié à portée 0–3 avec une initiative plus faible que la vôtre. Le vaisseau choisi gagne 1 marqueur d'évasion et retire 1 marqueur rouge non-stress.%LINEBREAK%<i>Errata (1.4): capacité modifiée</i>"""
        ...
        "Republic Judiciary":
           ...
           text: """<i class = flavor_text>La République Galactique utilise de petits vaisseaux de guerre véloces comme la corvette CR90 pour répondre rapidement aux incursions Séparatistes à travers la galaxie.</i>"""
        "Alderaanian Guard":
           display_name: """Garde Alderaanienne"""
           text: """<i class = flavor_text>Mise en service avant la Guerre des Clones, la corvette CR90 est privilégiée par la Maison Royale d'Alderaan pour sa polyvalence.</i>"""
        "Outer Rim Patrol":
           display_name: """Patrouille de la Bordure Extérieure"""
           text: """<i class = flavor_text>La corvette de classe Raider est l’un des plus petits vaisseaux de guerre de l’Empire, souvent utilisé pour des missions de reconnaissances, des frappes chirurgicales ou l’élimination des chasseurs ennemis grâce à sa puissante artillerie.</i>"""
        "First Order Collaborators":
           display_name: """Collaborateurs du Premier Ordre"""
           text: """<i class = flavor_text>Les partisans du Premier Ordre utilisent souvent d'anciens vaisseaux Impériaux, comme la corvette de classe Raider. Bien qu’il ait survécu au régime qui l’a vu naître, cet appareil répand toujours la terreur à travers la galaxie.</i>"""
        "Echo Base Evacuees":
           display_name: """Réfugiés de la Base Echo"""
           text: """<i class = flavor_text>Le transport moyen GR-75 s’adapte parfaitement aux batailles comme celle de l’évacuation de Hoth, durant laquelle plusieurs de ces vaisseaux ont été essentiels à la fuite des forces Rebelles.</i>"""
        "New Republic Volunteers":
           display_name: """Volontaires de la Nouvelle République"""
           text: """<i class = flavor_text>En service depuis la Guerre Civile Galactique, le transport moyen GR-75 est toujours utilisé par des membres de la Nouvelle République pour des missions d’approvisionnement et d’assistance.</i>"""
        "Outer Rim Garrison":
           display_name: """Garnison de la Bordure Extérieure"""
           text: """<i class = flavor_text>Capable de transporter 4 chasseurs TIE et d’opérer en autonomie durant de longues périodes, le croiseur de classe Gozanti est régulièrement aperçu dans les cieux des mondes opprimés de la Bordure Extérieure.</i>"""
        "First Order Sympathizers":
           display_name: """Sympathisants du Premier Ordre"""
           text: """<i class = flavor_text>La montée rapide au pouvoir du Premier Ordre se base sur une innovation féroce. Cependant, des sympathisants réutilisent régulièrement des concepts Impériaux, comme ce croiseur ancestral de classe Gozanti, pour des opérations de surveillance ou de patrouille.</i>"""
        "Separatist Privateers":
           display_name: """Corsaires Séparatistes"""
           text: """<i class = flavor_text>L’Alliance Séparatiste utilise tous les contacts douteux à sa disposition pour son combat contre la République Galactique, y compris des corsaires et des cartels criminels.</i>"""
        "Syndicate Smugglers":
           display_name: """Contrebandiers du Syndicat"""
           text: """<i class = flavor_text>Des vaisseaux comme le croiseur C-ROC facilitent les opérations criminelles à travers la Bordure Extérieure, en déplaçant de grandes quantités de matériels illicites ou en faisant étalage de leur puissance pour forcer les petites colonies à coopérer.</i>"""
        "Bossk (Z-95 Headhunter)":
           display_name: """Bossk"""
           text: """Tant que vous effectuez une attaque principale, après l’étape « Neutraliser les résultats », vous pouvez dépenser 1 résultat %CRIT% pour ajouter 2 résultats %HIT%."""
        "First Order Courier":
           display_name: """Messager du Premier Ordre"""
           text: """<i class = flavor_text>Le Premier Ordre se terre dans des bases dissimulées dans des secteurs discrets de la galaxie, répandant lentement son influence pernicieuse.</i>"""
        "Agent Terex":
        ...
        "Commander Malarus (Xi Shuttle)":
           ...
           text: """Tant qu’un vaisseau allié à portée 0–2 effectue une attaque principale, s’il a au moins 1 résultat vierge, il <b>doit</b> gagner 1 marqueur de contrainte pour relancer 1 résultat vierge, si possible (faites-le avant l’étape « Modifier les dés de défense »). %LINEBREAK% <i>Errata (1.3.2): Ajout d’une précision de timing pour éviter au joueur de contourner l’aspect négatif de cette capacité de vaisseau.</i>"""
        "Baktoid Drone":
           display_name: """Drone Baktoid"""
           text: """<i class = flavor_text>Développé tardivement pour la Confédération des Systèmes Indépendants, la canonnière droïde utilise des répulseurs spéciaux pour attaquer avec agilité ses cibles et larguer avec précision des droïdes de combat.</i>"""
        ...
        "Separatist Predator":
           ...
           text: """<i class = flavor_text>Dotée d’artillerie et protégée par des boucliers, une canonnière droïde peut faire autant de ravages contre les formations d’infanterie que contre les chasseurs de la République.</i>"""
        "Geonosian Prototype":
        ...
        "212th Battalion Pilot":
           ...
           text: """<i class = flavor_text>Capable de participer aussi bien à des combats spatiaux qu’à des batailles atmosphériques, la canonnière TABA/i transporte les troupes de la République sur les champs de bataille des planètes assiégées par les Séparatistes.</i>"""
        '"Hound"':
        ...
        "Carida Academy Cadet":
           ...
           text: """<i class = flavor_text>À l’académie militaire de Carida, les cadets de la Marine Impériale sont entraînés à être impitoyables et loyaux, privilégiant la victoire à la survie de leurs propres camarades.</i>"""
        "Onyx Squadron Sentry":
           display_name: """Sentinelle de l’Escadron Onyx"""
           text: """<i class = flavor_text>Le TIE/rb lourd, parfois surnommé la « brute », est conçu pour la polyvalence opérationnelle. Sa coque renforcée et sa capacité à accueillir un copilote droïde MGK-300 en font un excellent appareil de patrouille.</i>"""
        "Lyttan Dree":
        ...
        "Fearsome Predator":
           ...
           text: """<strong>Mise en Place</strong> : après avoir placé les forces, assignez l’état <b>Proie effrayée</b> à 1 vaisseau ennemi."""
        "DIS-347":
        ...
        "Colicoid Interceptor":
           ...
           text: """<i class = flavor_text>Conçu par le nid de création colicoïde et assemblé par Phlac-Arphocc Automata Industries, le processeur heuristique des Tri-Chasseurs Droïdes permet à ces redoutables appareils d’analyser et de s’adapter en temps réel aux tactiques de l’adversaire.</i>"""
        "Separatist Interceptor":
           display_name: """Intercepteur Séparatiste"""
           text: """<i class = flavor_text>Déployés tardivement durant la Guerre des Clones, ces chasseurs agressifs, et les nuées de droïdes buzz qu’ils transportent, sont une menace sérieuse même pour les pilotes Jedi vétérans.</i>"""
        "Separatist Racketeer":
           display_name: """Maître-Chanteur Séparatiste"""
           text: """<i class = flavor_text>Poussés par les nombreuses impasses causées par les Sièges de la Bordure Extérieure, des groupes de mercenaires saisissent à travers la galaxie l’opportunité de faire des bénéfices grâce à la guerre en cours.</i>"""
        ...
        "Jedi General":
           ...
           text: """<i class = flavor_text>Alors que la Guerre des Clones fait des ravages dans les rangs de l’Ordre Jedi, ceux qui restent assument de plus grandes responsabilités dans la Grande Armée de la République.</i>"""
        "Yoda":
        ...
        "Arliz Hadrassian":
           text: """Tant que vous effectuez une attaque %FRONTARC%, si vous êtes endommagé, vous pouvez changer 1 de vos résultats %FOCUS% en un résultat %CRIT%. %LINEBREAK% Tant que vous défendez, si vous êtes endommagé, vous <b>devez</b> changer 1 de vos résultats %FOCUS% en un résultat vierge (faites-le avant l’étape « Modifier les dés de défense »). %LINEBREAK% <i>Errata (RR: 1.3.2): Ajout d’une précision de timing pour éviter au joueur de contourner l’aspect négatif de cette capacité de vaisseau.</i>"""
        "Padric":
        ...
        "Jinata Security Officer":
           ...
           text: """<i class = flavor_text>Basé dans l’ancien bastion Impérial de Vardos, la Sécurité Jinata poursuit ses efforts de reconstruction sur la planète dévastée, tout en collaborant avec le programme de réarmement du Premier Ordre.</i>"""
        "Amaxine Warrior":
           display_name: """Guerrier Amaxine"""
           text: """<i class = flavor_text>Des décennies après la Bataille d’Endor, d’anciens Impériaux demeurent en activité au sein de la Nouvelle République. Beaucoup ont rejoint des organisations paramilitaires, comme celle des Guerriers Amaxines, qui s’approprient les traditions et cultures martiales pour répandre l’idéologie haineuse du Premier Ordre parmi les individus les plus influençables.</i>"""
        "Gamut Key":
        ...
        "Colicoid Destroyer":
           ...
           text: """<i class = flavor_text>Conçu par le Nid de Création Colicoïde et équipé de puissants tentacules et d'une foreuse géante capable de pénétrer n'importe quelle coque, y compris celles des vaisseaux et des bunkers les plus solides, le vaisseau d'Assaut de Classe Trident est une preuve terrifiante de la menace que représente l'Alliance Séparatiste.</i>"""
        "Lawless Pirates":
           display_name: """Pirates sans Foi ni Loi"""
           text: """<i class = flavor_text>L'Alliance Séparatiste a développé de bonnes relations avec certains mercenaires et groupuscules criminels et, alors que la guerre fait rage, ses technologies se retrouvent parfois dans des mains peu recommandables.</i>"""
        "Zorii Bliss":
        ...
        "Teza Nasz":
           text: """Tant qu'un vaisseau allié à portée 0-2 effectue une attaque, si le défenseur a un vaisseau qui est allié à l'attaquant dans chacun de ses arcs latéraux [ %LEFTARC% et %RIGHTARC% ], l'attaquant peut relancer 1 dé d'attaque."""
        "Wilsa Teshlo":
        ...
        "New Republic Patrol":
           ...
           text: """<i class = flavor_text>Conçu pour être personnalisable, le Y-Wing BTA-NR2 est utilisé par de nombreuses organisations militaires à travers la galaxie pour des tâches très variées, aussi bien comme appareil de maintien de l'ordre que comme bombardier en temps de guerre.</i>"""
        "Kijimi Spice Runner":
           display_name: """Trafiquant d'Épices de Kijimi"""
           text: """<i class = flavor_text>Menés par Zorii Bliss, les Trafiquants d'Épices de Kijimi ont délaissé leurs pratiques de mercenariat pour prendre part au combat contre le Dernier Ordre lors de la bataille d'Exegol.</i>"""
        ...
        "709th Legion Ace":
           ...
           text: """<i class = flavor_text>Commandée par le Suprême Leader Kylo Ren, la 709ème Légion combat sans pitié et sans remord afin d’écraser la Résistance et placer la galaxie sous la domination du Premier Ordre.</i>"""
        "Red Fury Zealot":
           display_name: """Extrémiste de la Red Fury"""
           text: """<i class = flavor_text>Également surnommé « Red Fury », la 709ème Légion est chargée par le Suprême Leader Kylo Ren d'éradiquer les dissidents à l'avant poste de Black Spire.</i>"""
        '"Breach"':
        ...
        "First Order Cadet":
           ...
           text: """<i class = flavor_text>Les exercices en conditions réelles du Premier Ordre sont destinées à éliminer les faibles, mettant en avant le dicton que seuls les forts survivent.</i>"""
        "Sienar-Jaemus Test Pilot":
           display_name: """Pilote d'Essai Sienar-Jaemus"""
           text: """<i class = flavor_text>Équipé de quatre canons laser et de systèmes avancés, le bombardier TIE/se est un appareil étonnamment manœuvrable, transportant un arsenal terrifiant capable d'annihiler tous ceux qui osent s'opposer au Premier Ordre.</i>"""
        "Bodica Venj":
        ...
        "Shadow Collective Operator":
           ...
           text: """<i class = flavor_text>Les anciens soldats de la Death Watch qui ont juré fidélité au Seigneur Maul continuent d'opérer à bord de Chasseurs Gauntlet, les utilisant parfois comme bombardiers lors d'attaques planifiées par Maul.</i>"""
        "Rook Kast":
        ...
        "Outer Rim Enforcer":
           ...
           text: """<i class = flavor_text>Conçu comme un appareil militaire, le Vaisseau d'Assaut ST-70 est très résistant et polyvalent. Pour ceux qui parcourent la Bordure Extérieure, le vaisseau peut servir de transport, d'appareil de combat et de simple habitat, le tout en même temps.</i>"""
        "Plo Koon (Delta-7b)":
           display_name: """Plo Koon"""
           text: """Au début de la phase d’engagement, vous pouvez dépenser 1 %FORCE% et choisir un autre vaisseau allié à portée 0–2. Dans ce cas, vous pouvez transférer 1 marqueur vert à ce vaisseau ou transférer 1 marqueur orange de ce vaisseau au vôtre."""
        ...
        "Nom Lumb (Rogue)":
           display_name: """Nom Lumb"""
           text: """Au début de la phase d’engagement, vous pouvez choisir 1 vaisseau ennemi dans votre %FRONTARC%. Dans ce cas, considérez votre initiative comme étant égale à celle de ce vaisseau jusqu’à la fin du round."""
        "Outer Rim Hunter":
           display_name: """Chasseur de la Bordure Extérieure"""
           text: """<i class = flavor_text>Cad Bane ayant démontré à quel point le Chasseur de Classe Rogue était efficace, d’autres chasseurs de primes ont rapidement adopté cet appareil, tout particulièrement ceux qui opèrent dans l’anarchique Bordure extérieure.</i>"""
        "Cad Bane (Separatist)":
        ...
        "MagnaGuard Executioner":
           ...
           text: """<i class = flavor_text>En plus de protéger les dirigeants Séparatistes, les droïdes Magna Garde sont parfois déployés dans les véloces Chasseurs de classe Rogue pour éliminer leurs ennemis.</i>"""
        '"Knack"':
           text: """Après que vous avez été détruit, vous pouvez choisir un vaisseau allié non-limité à portée 0-2 et lui assigner 1 de vos améliorations %TALENT% équipée. %LINEBREAK% <strong>Fin de Partie</strong> : remettez toutes les améliorations %TALENT% sur leurs vaisseaux d'origine."""
        '"Slider"':
        ...
        '"Warthog" (Z-95)':
           ...
           text: """Après que vous, ou un vaisseau allié non-limité à portée 0–2, avez été détruit lors de la phase d’engagement, ce vaisseau n’est retiré qu’à la fin de cette phase."""
        '"Boost"':
        ...
        '"Stub"':
           text: """Tant que vous défendez, si la vitesse de votre manœuvre révélée est paire, lancez 1 dé de défense supplémentaire. %LINEBREAK% Tant que vous effectuez une attaque principale, si la vitesse de votre manœuvre révélée est impaire, lancez 1 dé d'attaque supplémentaire."""
        '"Killer"':
        ...
        "Reaper Squadron Scout":
           ...
           text: """<i class = flavor_text>En dépit de la réputation peu flatteuse du Z-95 Clone, l'Escadron Reaper est devenu légendaire grâce aux talents de ses pilotes à manier habilement ce chasseur lors d'engagements variés comme l'escarmouche au dessus de Castilon.</i>"""
        "7th Sky Corps Pilot":
           display_name: """Pilote du 7ème Corps Céleste"""
           text: """<i class = flavor_text>Le chasseur Z-95 a gagné le respect des pilotes grâce à son adaptabilité et sa robustesse. La version des soldats clones de la république est conçue pour s'adapter aux compétences uniques de ses pilotes.</i>"""
        "Garven Dreis (BoY)":
           text: """Après voir dépensé un marqueur de concentration, vous pouvez choisir 1 vaisseau allié à portée 1–3. Ce vaisseau gagne 1 marqueur de concentration."""
        "Luke Skywalker (BoY)":
           text: """Après que vous avez été déclaré comme défenseur lors d’une attaque, vous pouvez récupérer 1 %FORCE%."""
        "Jek Porkins (BoY)":
           text: """Après avoir gagné un marqueur de stress, vous pouvez lancer 1 dé d’attaque pour le retirer. Si vous obtenez un résultat %HIT%, subissez 1 dégât %HIT%."""
        ...
        '"Dutch" Vander (BoY)':
           text: """Après avoir dépensé un verrouillage durant une attaque, choisissez 1 vaisseau allié à portée 1-3. Le vaisseau choisi peut verrouiller le défenseur."""
        "Dex Tiree (BoY)":
        ...
        '"Wampa" (BoY)':
           text: """Tant que vous effectuez une attaque, vous pouvez dépenser 1 %CHARGE% pour lancer 1 dé d’attaque supplémentaire. %LINEBREAK% Après avoir défendu, perdez 1 %CHARGE%."""
        "Iden Versio (BoY)":
           text: """Avant qu’un chasseur TIE allié à portée 0–1 ne subisse des dégâts, vous pouvez dépenser 2 %CHARGE%. Dans ce cas, prévenez 1 dégât."""
        "Sigma 4 (BoY)":
        ...
        '"Wolffe" (SoC)':
           text: """Tant que vous effectuez une attaque principale %FRONTARC%, vous pouvez dépenser 1 %CHARGE% pour relancer 1 dé d’attaque. %LINEBREAK% Tant que vous effectuez une attaque principale %REARARC%, vous pouvez récupérer 1 %CHARGE% pour lancer 1 dé d’attaque supplémentaire."""
        '"Jag" (SoC)':
        ...
        "Baktoid Prototype (SoC)":
           display_name: """Prototype Baktoid (SoC)"""
        ...
        "Phlac-Arphocc Prototype (SoC)":
           display_name: """Prototype Phlac-Arphocc (SoC)"""
           text: """Au début de la phase d’engagement, s’il y a un vaisseau ennemi dans votre %BULLSEYEARC%, gagnez un marqueur de calcul."""
        "DFS-081 (SoC)":
           text: """Tant que vous défendez, vous pouvez dépenser 1 %CHARGE% et 1 marqueur de calcul pour annuler un résultats %HIT%."""
        "DFS-311 (SoC)":
           text: """Au début de la phase d’engagement, vous pouvez transférer 1 de vos marqueurs de calcul à un autre vaisseau allié à portée 0–3."""
        "Haor Chall Prototype (SoC)":
           display_name: """Prototype Haor Chall (SoC)"""
        ...
        "Corran Horn (X-Wing)":
           display_name: """Corran Horn"""
           text: """Après que vous avez déclaré le défenseur d'une attaque, si vous avez un verrouillage sur le défenseur, un vaisseau allié qui a un marqueur de verrouillage sur vous peut transférer son marqueur au défenseur."""
        "Wes Janson":
        ...
        "Keo Venzee":
           text: """Si vous n'avez pas de %FORCE% active, après avoir révélé une manœuvre de virage sur l'aile (%BANKLEFT% ou %BANKRIGHT%) ou de virage (%TURNLEFT% ou %TURNRIGHT%), vous pouvez augmenter la difficulté de la manœuvre. Dans ce cas, effectuez cette manœuvre comme un dérapage et récupérez 1 %FORCE%."""
        '"Pops" Krail':
        ...
        "Poe Dameron (YT-1300)":
           display_name: """Poe Dameron"""
           text: """Avant que vous exécutiez une manœuvre, vous pouvez dépenser 1 %CHARGE%. Dans ce cas, ignorez les obstacles durant cette manœuvre. %LINEBREAK% Après avoir entièrement exécuté une manœuvre, vous pouvez dépenser 2 %CHARGE% pour effectuer une action %BOOST% blanche ou une action %BARRELROLL% rouge. Puis, si vous avez effectué une action %BARRELROLL% rouge, exposez 1 carte de dégât, si possible."""
...
# Starter Packs
    ...
    upgrade_translations =
        ...
        "Agent Kallus":
           ...
           text: """<strong>Mise en Place :</strong>Après avoir placé les forces, assignez l’état <strong>Traqué</strong> à 1 vaisseau ennemi.%LINEBREAK%Tant que vous effectuez une attaque contre le vaisseau qui possède l’état <strong>Traqué</strong>, vous pouvez changer 1 de vos résultats %FOCUS% en un résultat %HIT%. %LINEBREAK%<i>Errata (1.1.0)</i>:Ajout de « après avoir placé les forces, »</i>"""
        "Agile Gunner":
        ...
        "Angled Deflectors":
           ...
           text: """<i class = flavor_text>Les boucliers des chasseurs bénéficient souvent d’un contrôle manuel qui permet de les réorienter pour augmenter la protection avant ou arrière. Cependant, en agissant ainsi le vaisseau est exposé si la vigilance du pilote faiblit.</i>"""
        "Autoblasters":
        ...
        "BB Astromech":
           ...
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% pour effectuer une action %BARRELROLL%. %LINEBREAK% <i>Errata (1.5): l'effet de la carte intervient maintenant pendant la phase de système.</i>"""
        "BB-8":
           display_name: """BB-8"""
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% pour effectuer une action %BARRELROLL%. %LINEBREAK% <i>Errata (1.5): l'effet de la carte intervient maintenant pendant la phase de système.</i>"""
        "BT-1":
        ...
        "Bossk":
           display_name: """Bossk"""
           text: """Après avoir effectué une attaque principale ratée, si vous n’êtes pas stressé, vous <b>devez</b> recevoir 1 marqueur de stress pour effectuer une attaque principale bonus contre la même cible."""
        "Brilliant Evasion":
        ...
        "C1-10P":
           display_name: """C1-10P"""
           text: """<strong>C1-10P:</strong><strong>Mise en Place : </strong> à équiper avec cette face visible.%LINEBREAK%Après avoir entièrement exécuté une manœuvre, vous pouvez dépenser 1 %CHARGE% pour effectuer une action %EVADE% rouge, même si vous êtes stressé.%LINEBREAK%Lors de la phase de dénouement, si cette carte a 0 active, retournez-la.%LINEBREAK%<strong>C1-10P (Erratique)</strong>%LINEBREAK%Après avoir entièrement exécuté une manœuvre, vous <b>devez</b> choisir un vaisseau à portée 0-1.Il gagne 1 marqueur de brouillage. %LINEBREAK%<i>Errata (1.4): ajout de "entièrement"</i>"""
        "Cad Bane":
           display_name: """Cad Bane"""
        ...
        "Composure":
           ...
           text: """Après avoir échoué à une action, si vous n’avez aucun marqueur vert, vous pouvez effectuer une action %FOCUS%. Dans ce cas, vous ne pouvez pas effectuer d’actions supplémentaires à ce round. %LINEBREAK% <i>Errata (1.1.0): Ajout de « Dans ce cas, vous ne pouvez pas effectuer d’actions supplémentaires à ce round. »</i>"""
        "Concussion Missiles":
        ...
        "Contraband Cybernetics":
           ...
           text: """Avant votre activation, vous pouvez dépenser 1 %CHARGE%. Dans ce cas, jusqu’à la fin du round, vous pouvez effectuer des actions et exécuter des manœuvres rouges, même si vous êtes stressé. %LINEBREAK%La %CHARGE% de cette carte ne peut pas être récupérée. %LINEBREAK% <i>Errata (1.5): Ajout de la restriction de charge non récupérable.</i>"""
        "Count Dooku":
           display_name: """Comte Dooku"""
           text: """Durant une attaque, avant qu’un vaisseau à portée 0-2 ne lance des dés d’attaque ou de défense, si toutes vos %FORCE% sont actives, vous pouvez dépenser 1 %FORCE% et nommer un résultat. Si le lancer ne contient pas le résultat nommé, le vaisseau doit changer 1 dé pour ce résultat. %LINEBREAK%<i>Errata (1.4): Ajout de "Durant une attaque".</i>"""
        "Crack Shot":
        ...
        "Dedicated":
           display_name: """Dévoué"""
           text: """Tant qu’un autre vaisseau allié situé dans votre %LEFTARC% ou %RIGHTARC% à portée 0-2 défend, s’il est limité ou possède l’amélioration <strong>Dévoué</strong> et que vous n’êtes pas contraint, vous pouvez gagner 1 marqueur de contrainte. Dans ce cas, le défenseur relance 1 de ses résultats vierges. %LINEBREAK%<i>Errata (1.4): La restriction Non Limitée a été remplacée par le mot clé Clone</i>"""
        "Delayed Fuses":
        ...
        "Director Krennic":
           ...
           text: """<strong>Mise en Place :</strong> avant de placer les forces, assignez l’état <strong>Prototype Optimisé</strong> à un autre vaisseau allié."""
        "Dorsal Turret":
        ...
        "Engine Upgrade":
           ...
           text: """<i class = flavor_text>Les armées de grande taille comme celles de l’Empire Galactique ont des vaisseaux équipés de moteurs standardisés, mais les pilotes indépendants ou les petites organisations remplacent souvent les accouplements, rajoutent des propulseurs ou utilisent du carburant haute performance afin d’obtenir une poussée plus forte.</i>"""
        "Ensnare":
        ...
        "Expert Handling":
           ...
           text: """<i class = flavor_text>Bien que les chasseurs lourds puissent être déportés lors d’un tonneau, les pilotes chevronnés savent comment s’y prendre sans malmener leur vaisseau ou se rendre vulnérable à une attaque.</i>"""
        "Ezra Bridger":
           display_name: """Ezra Bridger"""
        ...
        "Ferrosphere Paint":
           ...
           text: """Après qu’un vaisseau ennemi vous a verrouillé, si vous n’êtes pas dans son %BULLSEYEARC%, il gagne 1 marqueur de stress sauf s’il choisit de rompre son verrouillage. %LINEBREAK%<i>Errata (1.4): Ajout de la possibilité que le vaisseau verrouillant puisse renoncer.</i>"""
        "Fifth Brother":
           display_name: """Le Cinquième Frère"""
        ...
        "GA-97":
           display_name: """GA-97"""
           text: """<strong>Mise en Place :</strong> avant de placer les forces, vous pouvez dépenser 3-5 %CHARGE%. Dans ce cas, choisissez un autre vaisseau allié et assignez-lui l’état <strong>C’est la Résistance</strong>."""
        'GNK "Gonk" Droid':
        ...
        "Grappling Struts":
           ...
           text: """<strong>Repliés: Mise en Place :</strong> à équiper avec cette face visible.%LINEBREAK%Tant que vous exécutez une manœuvre, si vous chevauchez un astéroïde ou un nuage de débris et qu’il y a 1 autre vaisseau allié ou moins à portée 0 de cet obstacle, vous pouvez retourner cette carte. Dans ce cas, vous ne subissez pas les effets de chevauchement de l’astéroïde ou du nuage de débris.%LINEBREAK%<strong>Dépliés:</strong>%LINEBREAK%Vous ignorez les obstacles à portée 0. Vous ne pouvez pas effectuer d'actions %BARRELROLL%. Après avoir révélé votre cadran, si vous avez révélé une manœuvre autre que [2 %STRAIGHT%] et que vous êtes à portée 0 d’un astéroïde ou d’un nuage de débris, sautez votre étape « Exécuter la manœuvre » et retirez 1 marqueur de stress ; si vous avez révélé une manœuvre à droite ou à gauche, faites pivoter votre vaisseau de 90° dans cette direction. Après avoir exécuté une manœuvre, retournez cette carte. %LINEBREAK%<i>Errata (1.4): Mise à jour du texte pour les nouvelles règles.</i>"""
        "Gravitic Deflection":
        ...
        "Leia Organa (Resistance)":
           ...
           text: """Après qu’un vaisseau allié a révélé une manœuvre non [0 %STOP% ], vous pouvez dépenser 1 %FORCE%. Dans ce cas, ce vaisseau allié réduit la difficulté de sa manœuvre. %LINEBREAK%<i>Errata (1.4): La capacité ne s'applique plus aux manœuvres de vitesse 0.</i>"""
        "Lone Wolf":
        ...
        "Luke Skywalker":
           display_name: """Luke Skywalker"""
           text: """Au début de la phase d’engagement, vous pouvez dépenser 1 %FORCE% et gagner 1 marqueur d'épuisement pour faire pivoter votre indicateur %SINGLETURRETARC%. %LINEBREAK%<i>Errata (1.4): Ajout du marqueur d'épuisement en coût.</i>"""
        "M9-G8":
           display_name: """M9-G8"""
        ...
        "Os-1 Arsenal Loadout":
           ...
           text: """Tant que vous avez exactement 1 marqueur de désarmement, vous pouvez toujours effectuer des attaques %TORPEDO% et %MISSILE% contre des cibles que vous avez verrouillées. Dans ce cas, vous ne pouvez pas dépenser votre marqueur de verrouillage pendant cette attaque."""
        "Outmaneuver":
        ...
        "R1-J5":
           display_name: """R1-J5"""
           text: """Tant que vous avez 2 marqueurs de stress ou moins, vous pouvez effectuer des actions des cartes de dégât, même si vous êtes stressé.%LINEBREAK%Après avoir réparé une carte de dégât avec le trait <strong>Vaisseau</strong>, vous pouvez dépenser 1 %CHARGE% pour réparer cette carte à nouveau."""
        "R2 Astromech":
        ...
        "Stabilized S-Foils":
           display_name: """S-foils Stabilisés"""
        ...
        "Static Discharge Vanes":
           ...
           text: """Avant que vous ne gagniez 1 marqueur ionique ou de brouillage, si vous n’êtes pas stressé, vous pouvez choisir un autre vaisseau à portée 0–1 et gagner 1 marquer de stress. Dans ce cas, le vaisseau choisi gagne ce marqueur ionique ou de brouillage à la place, puis vous subissez 1 dégât %HIT%. %LINEBREAK%<i>Errata (1.1.0): Cela remplace le texte d’origine : « Si vous devez gagner un marqueur ionique ou de brouillage, vous pouvez choisir un vaisseau à portée 0–1. Dans ce cas, gagnez 1 marqueur de stress et transférez 1 marqueur ionique ou de brouillage à ce vaisseau. »</i>"""
        "Stealth Device":
        ...
        "Supreme Leader Snoke":
           ...
           text: """Pendant la phase de système, vous pouvez choisir n’importe quel nombre de vaisseaux ennemis au-delà de la portée 1. Dans ce cas, dépensez autant de %FORCE% pour retourner face visible le cadran de manœuvres de chaque vaisseau choisi."""
        "Swarm Tactics":
        ...
        "Tactical Officer":
           ...
           text: """<i class = flavor_text>Dans la confusion d’un combat spatial, un simple ordre peut faire la différence entre une victoire et un carnage.</i>"""
        "Tactical Scrambler":
        ...
        "Targeting Computer":
           ...
           text: """<i class = flavor_text>Les ordinateurs de visée sont des dispositifs standards sur beaucoup de vaisseaux et plus spécifiquement sur ceux conçus pour utiliser de l’artillerie. Certains chasseurs légers et appareils de transport n’ont pas ce genre de guidage d’armes, mais il est toujours possible d’en installer en tant que modification.</i>"""
        ...
        "Xg-1 Assault Configuration":
           ...
           text: """Tant que vous avez exactement 1 marqueur de désarmement, vous pouvez toujours effectuer des attaques %CANNON%. Tant que vous effectuez une attaque %CANNON% alors que vous êtes désarmé, lancez 3 dés d’attaque au maximum."""
        "Zuckuss":
           display_name: """Zuckuss"""
        ...
        "Admiral Ozzel":
           ...
           text: """Tant qu’un vaisseau allié grand ou immense situé à portée 0–3 exécute une manœuvre, il peut subir 1 dégât %HIT% pour exécuter une manœuvre de même direction et difficulté à une vitesse supérieure ou inférieure de 1 à la place."""
        "Azmorigan":
        ...
        "Captain Needa":
           ...
           text: """Après qu’un vaisseau allié à portée 0–4 a révélé son cadran de manœuvres, vous pouvez dépenser 1 %CHARGE%. Dans ce cas, il règle son cadran sur une autre manœuvre de même vitesse et difficulté."""
        "Carlist Rieekan":
        ...
        "Ion Cannon Battery":
           ...
           text: """<strong>En ligne :</strong>%LINEBREAK%Mise en Place : à équiper avec cette face visible.%LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. Si cette attaque touche, le défenseur subit 1 dégât %CRIT% et tous les résultats %HIT%/%CRIT% infligent des marqueurs ioniques à la place des dégâts. %LINEBREAK%<strong>Hors-ligne :</strong>%LINEBREAK%Après que vous vous êtes engagé, vous pouvez dépenser 2 %ENERGY% pour retourner cette carte."""
        "Targeting Battery":
           display_name: """Batterie de Ciblage"""
           text: """<strong>En ligne :</strong>%LINEBREAK%Mise en Place : à équiper avec cette face visible.%LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. Après avoir effectué cette attaque, vous pouvez verrouiller le défenseur. %LINEBREAK%<strong>Hors-ligne :</strong>%LINEBREAK%Après que vous vous êtes engagé, vous pouvez dépenser 2 %ENERGY% pour retourner cette carte."""
        "Ordnance Tubes":
           display_name: """Tubes d’Artillerie"""
           text: """<strong>En ligne :</strong>%LINEBREAK%Mise en Place : à équiper avec cette face visible. %LINEBREAK%Vous pouvez effectuer des attaques %TORPEDO% et %MISSILE% uniquement en tant qu’attaque bonus. Vous <strong>devez</strong> considérer le prérequis %FRONTARC% de vos améliorations %TORPEDO% et %MISSILE% équipées comme étant %FULLFRONTARC%. %LINEBREAK%Attaque Bonus : effectuez une attaque %TORPEDO%. %LINEBREAK%Attaque Bonus : effectuez une attaque %MISSILE%. %LINEBREAK%<strong>Hors-ligne :</strong>%LINEBREAK%Vous <strong>devez</strong> considérer le prérequis %FRONTARC% de vos améliorations %TORPEDO% et %MISSILE% équipées comme étant %BULLSEYEARC%. %LINEBREAK% Action : dépensez 2 %ENERGY% pour retourner cette carte."""
        "Point-Defense Battery":
           display_name: """Batterie Défensive"""
           text: """<strong>En ligne :</strong>%LINEBREAK%Mise en Place : à équiper avec cette face visible. %LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. %LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. %LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. %LINEBREAK%Attaque Bonus : dépensez 1 %ENERGY%. %LINEBREAK%<strong>Hors-ligne :</strong>%LINEBREAK%Après que vous vous êtes engagé, vous pouvez dépenser 2 %ENERGY% pour retourner cette carte."""
        "Turbolaser Battery":
           display_name: """Batterie Turbolaser"""
           text: """<strong>En ligne :</strong>%LINEBREAK%Mise en Place : à équiper avec cette face visible.%LINEBREAK%Attaque Bonus [%LOCK%] : dépensez 3 %ENERGY%. Si cette attaque touche, ajoutez 3 résultats %HIT%. %LINEBREAK%<strong>Hors-ligne :</strong>%LINEBREAK%Après que vous vous êtes engagé, vous pouvez dépenser 2 %ENERGY% pour retourner cette carte."""
        "Toryn Farr":
        ...
        "Damage Control Team":
           ...
           text: """Avant de vous engager, vous pouvez dépenser 1 ou plusieurs %ENERGY% pour retourner autant de vos cartes d’amélioration <strong>Hors-ligne</strong>. %LINEBREAK%<strong>Action :</strong> dépensez 1 ou plusieurs %ENERGY% pour réparer autant de vos cartes de dégât <strong>Vaisseau</strong> face visible."""
        "Gunnery Specialists":
        ...
        "Adaptive Shields":
           ...
           text: """Tant qu’un autre vaisseau allié à portée 0–1 défend, s’il est d’une taille plus petite que vous, vous pouvez dépenser 1 %SHIELD% ou 2 %ENERGY% pour annuler 1 résultat %HIT% ou %CRIT%."""
        "Boosted Scanners":
           display_name: """Scanners Amplifiés"""
           text: """Tant que vous verrouillez, coordonnez ou brouillez, vous pouvez dépenser jusqu’à %ENERGY% pour augmenter la portée à laquelle vous pouvez choisir un objet de 1 par %ENERGY% dépensée de cette manière, pour une portée maximale de 5."""
        "Tibanna Reserves":
        ...
        "Optimized Power Core":
           ...
           text: """Après avoir exécuté une manœuvre bleue, récupérez 1 %ENERGY%."""
        "Quick-Release Locks":
        ...
        "Saboteur's Map":
           ...
           text: """À la fin de la Mise en place, vous pouvez dépenser jusqu’à 1 %CHARGE% de chacune de vos améliorations <strong>Mine</strong> équipées pour placer l’engin correspondant dans la zone de jeu au-delà de la portée 2 de tout vaisseau ennemi ou autre engin."""
        "Scanner Baffler":
        ...
        "Quantum Storm":
           text: """Après avoir entièrement exécuté une manœuvre blanche, récupérez 1 %ENERGY%."""
        "Assailer":
        ...
        "Broken Horn":
           text: """Si vous êtes endommagé, diminuez la difficulté de vos manœuvres ayant une vitesse 3–5."""
        "Merchant One":
        ...
        "Corsair Refit":
           ...
           text: """<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY% pour effectuer une attaque %CANNON%, %TURRET% ou %MISSILE%."""
        "Thunderstrike":
        ...
        "Repulsorlift Stabilizers":
           ...
           text: """<strong>Inactifs :</strong> %LINEBREAK%Mise en Place : à équiper avec cette face visible. %LINEBREAK%Diminuez la difficulté de vos manœuvres en ligne droite (%STRAIGHT%). %LINEBREAK%Après avoir entièrement exécuté une manœuvre, vous pouvez retourner cette carte. %LINEBREAK%<strong>Actifs :</strong> %LINEBREAK%Après avoir révélé une manœuvre de virage sur l'aile (%BANKLEFT% ou %BANKRIGHT%) ou de virage (%TURNLEFT% ou %TURNRIGHT%), vous <b>devez</b> effectuer cette manœuvre comme un dérapage, puis retournez cette carte. %LINEBREAK%Après avoir entièrement exécuté une manœuvre non-dérapage, vous pouvez retourner cette carte."""
        "Agent Terex":
           text: """<strong>Mise en Place :</strong> à équiper avec cette face visible. Placez 3 marqueurs de calcul sur cette carte. %LINEBREAK%Au début de la phase d’engagement, vous pouvez choisir un vaisseau allié à portée 0–3 et retirer 1 marqueur de calcul de cette carte pour que ce vaisseau allié gagne un marqueur correspondant. Puis, s’il n’y a plus de marqueurs de calcul sur cette carte, retournez-la. %LINEBREAK%<strong>Cyborg :</strong> %LINEBREAK%Pendant la phase de système, lancez 1 dé d’attaque. Sur un résultat %HIT% ou %CRIT% gagnez 1 marqueur de calcul. Sinon, gagnez 1 marqueur de brouillage. %LINEBREAK%<strong>Action :</strong> transférez 1 marqueur de calcul ou de brouillage à un vaisseau à portée 0–3."""
        "Plo Koon":
        ...
        "Multi-Missile Pods":
           display_name: """Nacelles Multi-Missiles"""
           text: """Attaque (%CALCULATE% ou %LOCK%) : dépensez 1 %CHARGE%. Si le défenseur est dans votre %FRONTARC%, vous pouvez dépenser 1 %CHARGE% pour lancer 1 dé d’attaque supplémentaire. Si le défenseur est dans votre %BULLSEYEARC%, vous pouvez dépenser jusqu’à 2 %CHARGE% pour lancer autant de dés supplémentaires à la place."""
        "Kit Fisto":
        ...
        "Zam Wesell":
           text: """<strong>Mise en Place :</strong> perdez 2 %CHARGE%. %LINEBREAK%Pendant la phase de système, vous pouvez vous assigner, face cachée, 1 de vos états secrets : %LINEBREAK%<strong>Vous Devriez me Remercier</strong> %LINEBREAK%<strong>Vous Devriez Faire des Affaires</strong>"""
        'Alpha-3B "Besh"':
        ...
        "Sensor Buoy Suite":
           ...
           text: """<strong>Mise en Place :</strong> avant de placer les forces, placez 2 engins distants Balise Dérivante de Détection au-delà de la portée 2 de n’importe quel bord. %LINEBREAK%Avant de vous engager, vous pouvez verrouiller un vaisseau à portée 0–1 de n’importe quelle balise dérivante de détection alliée, en ignorant les restrictions de portée."""
        "Ghost Company":
        ...
        "R2-D2 (Resistance)":
           display_name: """R2-D2"""
           text: """Pendant la phase de dénouement, vous pouvez dépenser 1 %CHARGE% et 1 %SHIELD% pour retirer 1 marqueur rouge. %LINEBREAK%Pendant la phase de dénouement, si vous n’avez aucun %SHIELD% actif, vous pouvez dépenser 2 %CHARGE% pour récupérer 1 %SHIELD% et gagner 1 marqueur d’épuisement."""
        "R6-D8":
        ...
        "Protectorate Gleb":
           ...
           text: """Après avoir coordonné un vaisseau allié, vous pouvez transférer 1 marqueur orange ou rouge au vaisseau que vous avez coordonné. %LINEBREAK%<i>Errata (1.3.2): Ajout de "...un vaisseau allié..."</i>"""
        "R4-B11":
        ...
        "Asajj Ventress (Command)":
           display_name: """Asajj Ventress"""
           text: """Pendant la phase de système, vous pouvez dépenser 1 %FORCE%. Dans ce cas, chaque vaisseau ennemi dans votre %FRONTARC% à portée 0-1 gagne 1 marqueur de contrainte sauf s'il choisit de gagner 1 marqueur de brouillage. %LINEBREAK%<i>Errata (1.3.2): Ajout du symbole à la droite du modificateur de Force.</i>"""
        "General Grievous (Command)":
           display_name: """Général Grievous"""
           text: """Tant que vous défendez, après l’étape « Neutraliser les résultats », s’il y a au moins 2 résultats %HIT%/%CRIT%, vous pouvez dépenser 1 %CHARGE% pour annuler 1 résultat %HIT% ou %CRIT%. %LINEBREAK%Après qu’un vaisseau allié a été détruit, récupérez 1 %CHARGE%."""
        "Hondo Ohnaka (Command)":
           display_name: """Hondo Ohnaka"""
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% et choisir 1 vaisseau allié à portée 0-1. Déplacez 1 marqueur de Victoire ou marqueur d'Objectif de la carte de ce vaisseau vers la vôtre ou de votre carte de vaisseau vers la sienne."""
        "Mar Tuuk":
           text: """<strong>Mise en Place :</strong> après avoir placé les forces, choisissez 1 patrouille alliée de vaisseaux dotés de %CALCULATE% dans leur barre d'action et placez cette patrouille en réserve. %LINEBREAK%Pendant la phase de dénouement vous pouvez placer cette patrouille dans votre zone de déploiement ou au-delà de la portée 2 de tout vaisseau ennemi. Puis vous pouvez choisir 1 vaisseau ennemi situé à portée 0-1 de vous : chaque vaisseau de cette patrouille verrouille ce vaisseau ennemi."""
        "Riff Tamson":
        ...
        "Tractor Tentacles":
           ...
           text: """<strong>Mise en Place :</strong> à équiper avec cette face visible. %LINEBREAK%<strong>Attaque Bonus</strong> %LINEBREAK%<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY%. %LINEBREAK%<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY%. %LINEBREAK%<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY%. %LINEBREAK%<strong>Hors-ligne :</strong> %LINEBREAK%<strong>Action :</strong> Dépensez 1 %ENERGY% pour retourner cette carte."""
        "Drill Beak":
           display_name: """Trépan de Forage"""
           text: """<strong>Mise en Place :</strong> à équiper avec cette face visible. %LINEBREAK%Vous pouvez effectuer cette attaque à portée 0. %LINEBREAK%<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY%. Si la portée d'attaque est 0, changez tout les résultats %HIT% en résultats %CRIT%. %LINEBREAK%<strong>Hors-ligne :</strong> %LINEBREAK%<strong>Action :</strong> Dépensez 1 %ENERGY% pour retourner cette carte."""
        "Enhanced Propulsion":
        ...
        "Proton Cannon Battery":
           ...
           text: """<strong>Mise en Place :</strong> à équiper avec cette face visible. %LINEBREAK%<strong>Attaque Bonus :</strong> changez 1 résultat %HIT% en un résultat %CRIT%. %LINEBREAK%<strong>Attaque Bonus :</strong> dépensez 1 %ENERGY%. Changez 1 résultat %HIT% en un résultat %CRIT%. %LINEBREAK%<strong>Hors-ligne :</strong> %LINEBREAK%<strong>Action :</strong> Dépensez 1 %ENERGY% pour retourner cette carte."""
        "Droid Crew":
        ...
        "Tracking Torpedoes":
           ...
           text: """Pendant la phase de système, vous pouvez dépenser jusqu'à 3 %CHARGE% pour lancer autant de torpilles auto-guidées en utilisant les gabarits [3%BANKLEFT%], [4%STRAIGHT%] ou [3%BANKRIGHT%]. Chaque engin doit utiliser un gabarit différent. Puis chaque engin peut verrouiller un objet que vous avez verrouillé, en ignorant les restrictions de portée. %LINEBREAK%Les %CHARGE% de cette carte ne peuvent pas être récupérées. %LINEBREAK%<i>Errata (1.3.2) : Ajout de la non-récupération des charges.</i>"""
        "L4E-R5":
        ...
        "Wartime Loadout":
           ...
           text: """Remplacez votre capacité de vaisseau par la suivante : %LINEBREAK%<strong>Tir de Barrage Dévastateur :</strong> tant que vous effectuez une attaque %TORPEDO% ou %MISSILE% si le défenseur est dans votre %BULLSEYEARC%, vos résultats %CRIT% ne peuvent pas être annulés par des résultats %EVADE%."""
        "Watchful Astromech":
        ...
        "Malice":
           text: """Tant que vous effectuez une attaque, vous pouvez dépenser 1 %FORCE% pour changer 1 résultat %FOCUS% ou %HIT% en 1 résultat %CRIT%. Dans ce cas, après avoir effectué cette attaque, si au moins 1 carte de dégât <b>Pilote</b> ou <b>Équipage</b> a été attribué face visible au défenseur, récupérez 2 %FORCE%"""
        "Shattering Shot":
        ...
        "Electro-Chaff Missiles":
           ...
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% de cette carte pour lancer 1 nuage de Paillettes Électriques en utilisant le gabarit [3 %BANKLEFT%], [3 %BANKRIGHT%] ou [4 %STRAIGHT%]. Puis placez 1 marqueur d'amorce dessus."""
        "Feedback Ping":
        ...
        "Clan Training":
           ...
           text: """Avant de vous engager, si vous n'êtes pas concentré et qu'il y a un vaisseau ennemi dans votre %FRONTARC% à portée 1, vous pouvez dépenser 1 %CHARGE% pour effectuer une action rouge. %LINEBREAK%Après que vous avez effectué une attaque. Si le défenseur est détruit, récupérez 1 %CHARGE%"""
        "Ahsoka Tano (Crew)":
           display_name: """Ahsoka Tano"""
        ...
        "Korkie Kryze":
           text: """Après qu'un vaisseau allié dans votre %FULLFRONTARC% à portée 1-2 est devenu le défenseur, vous pouvez lui transférer 1 marqueur vert."""
        "Obi-Wan Kenobi":
        ...
        "Ursa Wren":
           text: """Vous pouvez maintenir jusqu'à 2 verrouillages. Chaque verrouillage doit être sur un objet différent. %LINEBREAK%Après qu'un vaisseau allié à portée 0-3 a été verrouillé par un vaisseau ennemi, vous pouvez effectuer une action %LOCK%. %LINEBREAK% <i>Errata (1.5): Texte mis à jour pour correspondre à l'effet recherché initialement.</i>"""
        "Maul (Mandalore)":
           text: """ """
        "Gar Saxon (Gunner)":
           display_name: """Gar Saxon"""
           text: """Tant que vous effectuez l'action %LOCK% vous pouvez choisir uniquement un objet dans votre %FRONTARC% ou votre %REARARC% tant que vous effectuez une attaque principale, si le défenseur est dans votre %FRONTARC% ou votre %REARARC%, vous pouvez retirer 1 marqueur rouge ou orange du défenseur pour lancer 1 dé supplémentaire, pour un maximum de 4."""
        "Tiber Saxon":
        ...
        "Beskar Reinforced Plating":
           ...
           text: """Tant que vous défendez si l'attaquant est dans votre %FRONTARC%, avant qu'une carte de dégât ne vous soit attribuée face visible, vous pouvez dépenser 1 %CHARGE% pour recevoir cette carte face cachée à la place ou dépenser 2 %CHARGE% pour la défausser."""
        "Mandalorian Optics":
        ...
        "Swivel Wing":
           ...
           text: """<strong>Aile Basculante (Baissée) :</strong> %LINEBREAK%Après avoir exécuté une manœuvre [0 %STOP%], vous pouvez pivoter votre vaisseau de 90° ou 180°. Dans ce cas vous <b>devez</b> retourner cette carte. %LINEBREAK%<strong>Aile Basculante (Levée) :</strong> %LINEBREAK%Tant que vous défendez, lancez 1 dé de défense en moins. %LINEBREAK%Après avoir entièrement exécuté une manœuvre non-stationnaire [0 %STOP%], vous pouvez retourner cette carte."""
        "Clan Wren Commandos":
           display_name: """Commandos du Clan Wren"""
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% pour larguer un engin distant Équipe Commandos en utilisant le gabarit [1 %STRAIGHT%]. Vous pouvez placer cet engin en utilisant ses glissières avant ou arrière."""
        "Razor Crest":
        ...
        "Enduring":
           ...
           text: """Tant que vous défendez, si vous n'êtes pas dans le %BULLSEYEARC% de l'attaquant, les résultats %CRIT% sont neutralisés avant les résultats %HIT%. Après avoir subi 1 ou plusieurs dégâts %CRIT%, vous pouvez effectuer une action %CALCULATE% ou %FOCUS% de votre barre d'action, même si vous êtes stressé, en considérant cette action comme rouge."""
        "IG-11":
           text: """<strong>Mise en Place :</strong> à équiper avec cette face visible. %LINEBREAK%Avant qu'une carte de dégât ne vous soit attribuée face visible, vous <b>devez</b> placer 1 marqueur d'amorce sur cette amélioration et gagnez 1 marqueur de calcul à la place. Puis s'il y a 2 marqueurs d'amorce sur cette amélioration, retournez-la. %LINEBREAK%<strong>IG-11 (Protocole Anti-Capture)</strong> %LINEBREAK%Pendant la phase de dénouement, retirez 1 marqueur d'amorce de cette carte. Puis, si cette carte n'a plus de marqueur d'amorce, vous êtes détruit et chaque autre vaisseau à portée 0-1 subit 1 dégât %CRIT%. %LINEBREAK%<strong>Action :</strong> placez 1 marqueur d'amorce sur cette carte."""
        "Greef Karga":
        ...
        "Kuiil":
           text: """<strong>Action :</strong> lancez 1 dé d'attaque pour chaque carte de dégât que vous avez. Pour chaque résultat %HIT%, réparez 1 carte de dégât <b>Vaisseau</b> face visible, puis pour chaque résultat %CRIT%, réparez 1 carte de dégât face cachée. Pour chaque résultat vierge, retirez 1 marqueur orange, puis pour chaque résultat %FOCUS% gagnez 1 marqueur de concentration."""
        "Peli Motto":
        ...
        "Burnout Thrusters":
           ...
           text: """Après avoir effectué une action %SLAM%, perdez 1 %CHARGE%. Puis vous pouvez gagner 1 marqueur d'épuisement pour retirer 1 marqueur de désarmement. %LINEBREAK%Si votre %CHARGE% est inactive, vous ne pouvez pas effectuer d'action %SLAM%."""
        ...
        "Mandalorian Super Commandos":
           ...
           text: """Pendant la phase de système, vous pouvez dépenser 1 %CHARGE% pour larguer un engin distant <b>Équipe Commandos</b> en utilisant le gabarit [1 %STRAIGHT% ]. Vous pouvez placer cet engin en utilisant ses glissières avant ou arrière. %LINEBREAK%Les %CHARGE% de cette carte ne peuvent pas être récupérées."""
        ...
        "Homing Torpedoes":
           ...
           text: """<strong>Attaque (%LOCK%) :</strong> Dépensez 1 %CHARGE%. Après que vous avez déclaré le défenseur, il peut choisir de subir 1 dégât %CRIT%. Dans ce cas, sautez les étapes « Dés d'attaque » et « Dés de défense » et considérez que l'attaque a touché."""
        "Xanadu Blood":
           text: """ """
        "Fanatic (BoY)":
        ...
        "Attack Speed (BoY)":
           ...
           text: """Après avoir entièrement exécuté une manœuvre [3%STRAIGHT%] ou [4%STRAIGHT%], vous pouvez effectuer une accélération en utilisant le gabarit [1%STRAIGHT%]."""
        ...
        "Precise Astromech (BoY)":
           ...
           text: """Après que vous avez effectué une action, vous pouvez dépenser 1 %CHARGE% pour effectuer une action %LOCK% rouge."""
        "R2-A3 (BoY)":
           display_name: """R2-A3"""
           text: """Après avoir révélé votre cadran, vous pouvez dépenser 1 %CHARGE% et gagner 1 marqueur de désarmement pour récupérer 1 bouclier."""
        "Vengeful (BoY)":
    ...
    condition_translations =
        ...
        'Hunted':
           display_name: 'Traqué'
           text: '''Après avoir été détruit, vous <b>devez</b> choisir un autre vaisseau allié et lui assigner cet état, si possible.'''
        'Listening Device':
    ...
    chassis_translations =
        ...
        "Adaptive Ailerons":
           ...
           text: """avant de révéler votre cadran, si vous n’êtes pas stressé, vous <b>devez</b> accélérer. %LINEBREAK% <i>Errata (1.4.2): capacité du vaisseau modifiée</i>"""
        "Pursuit Craft":
        ...
        "Controlled Ailerons":
           ...
           text: """avant de révéler votre cadran, si vous n’êtes pas stressé, vous pouvez accélérer. %LINEBREAK% <i>Errata (1.4.2): Capacité du vaisseau modifiée</i>"""
        "Co-Pilot":
        ...
        "Pinpoint Tractor Array":
           ...
           text: """vous ne pouvez pas faire pivoter votre %SINGLETURRETARC% vers votre %REARARC%. Après avoir entièrement exécuté une manœuvre, vous pouvez gagner 1 marqueur de rayon tracteur pour effectuer une action %ROTATEARC%. %LINEBREAK%<i>Errata (1.4): ajout de "entièrement"</i>"""
        "Plated Hull":
