###
    ...
    - Alberto Tudela <ajtudela@gmail.com> https://github.com/ajtudela
###
...
exportObj.translations['Español'] =
    ...
    ui:
        ...
        damageHeader: (translator, type) ->
            "Carta de daño (#{translator 'tipo', type})"
        "unreleased": "sin publicar"
        "epic": "épico"
        "Quickbuild": "Creación rápida"
        "limited": "limitado"
        "Unreleased content warning": "¡Este escuadrón usa contenido aún no publicado!"
        "Broken squad link warning": "Parece que seguiste un enlace roto. ¡No se pudo cargar ningún escuadrón!"
        "Collection warning": "¡No puedes desplegar esta lista con tu colección!"
        shipNumberWarning: (translator, data) -> "¡Un escuadrón legal de torneo debe contener de #{data[0]} a #{data[1]} naves!"
        "Multi-Faction warning": "¡Las listas de múltiples facciones NUNCA son legales para torneos!"
        "XWS Import Dialog": "Importa tu lista a través de XWS a YASB.<br><i>XWS es un formato común para compartir listas entre aplicaciones.</i>"
        "Copy below simple text": "<p>Copie lo siguiente y pegarlo en otro lugar.</p>"
        "Copy below markdown": "<p>Copie lo siguiente y péguelo en su publicación de Reddit.</p><p>Asegúrese de que el editor de publicaciones esté configurado en modo Markdown.</p>"
        "Copy below TTS": "<p>Copie lo siguiente y péguelo en Tabletop Simulator.</p>"
        "Copy below BBCode": "<p>Copie el BBCode a continuación y péguelo en su publicación del foro.</p>"
        "Copy below HTML": "<p>Copie el siguiente y péguelo en otro lugar.</p>"
        ...
        varPointCostsConditionIni: (translator, values) ->
            "iniciativa es #{values}"
        varPointCostsConditionBase: (translator, values) ->
            "tamaño de base es pequeña, mediana, grande o enorme"
        "Missing Item List:": "Para desplegar este escuadrón necesitas los siguientes elementos adicionales:" 
        pilotFlyingShip: (translator, pilot, ship) ->
            "Piloto #{pilot} volando #{ship}"
        ...
        reallyDeleteSquadXY: (translator, squadname) -> 
            "¿Desea realmente eliminar #{squadname}?"
        ...
        "OAuth explanation" : """
                     ...
                     <p>
                         La mejor parte de esto es que no tienes que crear un nuevo nombre de usuario y contraseña para recordar. Y no te preocupes, no estoy recopilando ningún dato de los proveedores sobre ti. Intenté configurar el alcance de los datos para que sea lo más pequeño posible, pero algunos lugares envían una gran cantidad de datos como mínimo. Lo tiro. Todo lo que miro es un identificador único (generalmente un número gigante).
                     </p>
                     <p>
                         Para obtener más información, consulte esta <a href="http://hueniverse.com/oauth/guide/intro/" target="_blank">introducción a OAuth</a>.
                     </p>
                    """
        "Intro Card YASB": """
                     ...
                     <p>YASB es actualizado y mantenido por Stephen Kim.</p>
                     <p>Créditos adicionales para:<br>
                     2.5 Actualizar datos: Devon Monkhouse, Perry Low, Andrew Oehler.<br>
                     Datos de lanzamiento de 2.0: Evan Cameron, Jonathan Hon, Devon Monkhouse y Mark Stewart.<br>
                     Equipo de traducción: Patrick Mischke, godgremos, Clément Bourgoin, ManuelWittke, kksuke<br>
                     Logotipo del sitio: Thomas Kohler<br>
                     Compatibilidad con compilación rápida: Patrick Mischke</p>

                     <p>Este constructor no es oficial y no está afiliado a Atomic Mass Games, Lucasfilm Ltd. o Disney.</p>
...
exportObj.cardLoaders['Español'] = () ->
    ...
    # Rename ships
    exportObj.renameShip """Modified YT-1300 Light Freighter""", """Carguero ligero YT-1300 modificado"""
    exportObj.renameShip """StarViper-class Attack Platform""", """Plataforma de ataque clase Víbora Estelar"""
    exportObj.renameShip """Scurrg H-6 Bomber""", """Bombardero Scurrg H-6"""
    exportObj.renameShip """YT-2400 Light Freighter""", """Carguero ligero YT-2400"""
    ...
    exportObj.renameShip """Quadrijet Transfer Spacetug""", """Remolcador espacial cuatrimotor"""
    exportObj.renameShip """Firespray-class Patrol Craft""", """Patrullera clase Firespray"""
    exportObj.renameShip """TIE/ln Fighter""", """Caza TIE/ln"""
    ...
    pilot_translations =
        "0-66":
           display_name: """0-66"""
           text: """Después de que te defiendas, puedes gastar 1 ficha de Cálculos para realizar una acción."""
        "104th Battalion Pilot":
           display_name: """Piloto del Batallón 104"""
           text: """<i class = flavor_text>El ARC-170 se diseñó como un caza pesado de escolta de altas prestaciones provisto de una potente combinación de láseres frontales y posteriores, cabezas de guerra y un droide astromecánico para tareas de navegación. Los escuadrones de estas impresionantes naves afianzaban la presencia de la Armada de la República en toda batalla en la que intervinieran.</i>"""
        "4-LOM":
           display_name: """4-LOM"""
        ...
        "Ahhav":
           display_name: """Ahhav"""
           text: """Mientras te defiendes o efectúas un ataque, tira 1 dado adicional si la nave enemiga es de un tamaño más grande que el tuyo."""
        "Ahsoka Tano":
        ...
        "Baktoid Prototype":
           ...
           text: """Mientras efectúas un ataque especial, si una nave aliada con la capacidad de nave <strong>Procesado de cálculos en red</strong> tiene un Blanco fijado sobre el defensor, puedes ignorar el requisito %FOCUS%, %CALCULATE% o %LOCK% de ese ataque. """
        "Baron of the Empire":
        ...
        "Barriss Offee":
           ...
           text: """Mientras una nave aliada que tienes a alcance 0-2 efectúa un ataque, si el defensor está situado en el %BULLSEYEARC%, del atacante, puedes gastar 1 %FORCE% para cambiar 1 resultado %FOCUS% por un resultado %HIT% o 1 resultado %HIT% por un resultado %CRIT%."""
        "Barriss Offee (Delta-7b)":
           display_name: """Barriss Offee"""
           text: """Mientras una nave aliada que tienes a alcance 0-2 efectúa un ataque, si el defensor está situado en el %BULLSEYEARC%, del atacante, puedes gastar 1 %FORCE% para cambiar 1 resultado %FOCUS% por un resultado %HIT% o 1 resultado %HIT% por un resultado %CRIT%."""
        "Ben Teene":
           display_name: """Ben Teene"""
           text: """Después de que efectúes un ataque, si el defensor está situado en tu %SINGLETURRETARC%, asígnale el estado <strong>Estremecido </strong>."""
        "Benthic Two Tubes":
        ...
        "Black Squadron Ace (T-70)":
           display_name: """As del Escuadrón Negro"""
           text: """<i class = flavor_text>Durante la Guerra Fría, el Escuadrón Negro de Poe Dameron llevó a cabo audaces operaciones encubiertas contra la Primera Orden, contraviniendo los tratados que habían sido ratificados por el Senado de la Nueva República.</i>"""
        "Black Squadron Scout":
           display_name: """Explorador Esc. Negro"""
           text: """<i class = flavor_text>Estas naves atmosféricas fuertemente armadas obtienen una mayor velocidad y maniobrabilidad gracias a sus alas móviles especialmente diseñadas.</i>"""
        "Black Sun Ace":
        ...
        "Blue Squadron Protector":
           display_name: """Protector del Escuadrón Azul"""
           text: """<i class = flavor_text>Los pilotos clon de élite del Escuadrón Azul están entrenados para volar en sus V-19 acompañando a pilotos jedi, y suelen prestar apoyo a comandantes famosos como Anakin Skywalker y Ahsoka Tano.</i>"""
        "Blue Squadron Recruit":
           display_name: """Recluta del Escuadrón Azul"""
           text: """<i class = flavor_text>Jóvenes de toda la galaxia han crecido escuchando heroicos relatos de la Guerra Civil Galáctica, y muchos de ellos aprendieron a pilotar en las mismas carlingas en las que sus padres combatieron al Imperio.</i>"""
        "Blue Squadron Rookie":
           display_name: """Novato del Escuadrón Azul"""
           text: """<i class = flavor_text>El T-70 Ala-X de Incom-FreiTek se diseñó para ampliar la flexibilidad táctica del venerable T-65. Su sofisticado puerto para droides astromecánicos es compatible con una amplia variedad de modelos, y sus cápsulas modulares de armamento permiten al personal técnico adaptar para misiones específicas la configuración de armas del caza.</i>"""
        "Blue Squadron Scout":
        ...
        "Captain Seevor":
           display_name: """Capitán Seevor"""
           text: """Mientras te defiendes o efectúas un ataque, antes de que se tiren los dados de ataque, si no estás situado en el %BULLSEYEARC% de la nave enemiga, puedes gastar 1 %CHARGE%. Si lo haces, la nave enemiga recibe 1 ficha de Interferencia."""
        "Cartel Executioner":
        ...
        "Cat":
           display_name: """Cat"""
           text: """Mientras efectúas un ataque principal, tira 1 dado adicional si el defensor está situado a alcance 0-1 de al menos 1 dispositivo aliado."""
        ...
        "Chewbacca (Resistance)":
           display_name: """Chewbacca"""
           text: """Después de que una nave aliada que tengas a alcance 0-3 sea destruida, puedes realizar una acción. Luego puedes efectuar un ataque adicional.%LINEBREAK%<i><strong>Nota:</strong>La frase "antes de que se elimine ese barco" no está impresa en la tarjeta, sino en el creador de escuadrones oficial.</i>"""
        "Cobalt Squadron Bomber":
           display_name: """Bombardero del Escuadrón Cobalto"""
           text: """<i class = flavor_text>Ya estén los silos de munición de sus Fortalezas Estelares cargados con bombas de protones o suministros básicos para emergencias, las heroicas tripulaciones del Escuadrón Cobalto dedican sus vidas a cambiar la galaxia para mejor.</i>"""
        "Colonel Jendon":
        ...
        "Commander Malarus":
           ...
           text: """Al comienzo de la fase de Enfrentamiento, puedes gastar 1 %CHARGE% y recibir 1 ficha de Tensión. Si lo haces, hasta el final de la ronda, mientras te defiendes o efectúas un ataque, puedes cambiar todos tus resultados %FOCUS% por resultados  %EVADE% o %HIT%."""
        "Constable Zuvio":
        ...
        "Count Dooku":
           display_name: """Conde Dooku"""
           text: """Después de que te defiendas, si el atacante está situado en tu arco de fuego, puedes gastar 1 %FORCE% para retirar 1 de tus fichas azules o rojas.%LINEBREAK%Después de que efectúes un ataque que impacte, puedes gastar 1 %FORCE% para realizar una acción."""
        "Countess Ryad":
        ...
        "DBS-32C":
           ...
           text: """Al comienzo de la fase de Enfrentamiento, puedes gastar 1 ficha de Cálculos para realizar una acción %COORDINATE%. No puedes coordinar naves que no tengan la capacidad de nave <strong>Procesado de cálculos en red</strong>. """
        "DBS-404":
        ...
        "DFS-081":
           ...
           text: """Mientras una nave aliada que tienes a alcance 0-1 se defiende, esa nave puede gastar 1 ficha de Cálculos para cambiar todos los resultados %CRIT% por resultados  %HIT%."""
        "DFS-311":
        ...
        "Edon Kappehl":
           ...
           text: """Después de que ejecutes completamente una maniobra azul o blanca, si no has soltado ni lanzado ningún dispositivo en esta ronda, puedes soltar 1 dispositivo."""
        "Edrio Two Tubes":
        ...
        "Ello Asty":
           ...
           text: """Después de que reveles una maniobra de giro Tallon [%TROLLLEFT% o %TROLLRIGHT%] roja, si tienes 2 o menos fichas de Tensión, considera esa maniobra como si fuera blanca."""
        "Emon Azzameen":
        ...
        "Epsilon Squadron Cadet":
           ...
           text: """<i class = flavor_text>Entrenados desde su infancia a bordo de destructores estelares clase Resurgente en pleno espacio profundo, muchos de los pilotos de cazas TIE de la Primera Orden nunca han llegado a pisar la superficie de un planeta.</i>"""
        "Esege Tuketu":
        ...
        "Feethan Ottraw Autopilot":
           display_name: """Piloto automático de Feethan Ottraw"""
           text: """<i class = flavor_text>A diferencia de otros cazas más sacrificables que también fabrica para las fuerzas separatistas, Ensamblados Escalables Feethan Ottraw diseñó el Belbullab-22 con una sólida combinación de potencia de fuego, resistencia y versatilidad.</i>"""
        ...
        "First Order Test Pilot":
           ...
           text: """<i class = flavor_text>Diseñado para alcanzar una velocidad y maniobrabilidad asombrosas, el Silenciador TIE resulta devastador en manos de quienes saben aprovechar todo su potencial. Su agilidad es tal que los pilotos mediocres pueden perder el control de la nave al menor descuido.</i>"""
        "Foreman Proach":
           display_name: """Capataz  Proach"""
           text: """Antes de que intervengas, puedes elegir 1 nave enemiga que tengas a alcance 1-2 y esté situada en tu %BULLSEYEARC% y recibir 1 ficha de Desarme. Si lo haces, esa nave recibe 1 ficha de Campo de tracción."""
        "Freighter Captain":
        ...
        "General Grievous":
           ...
           text: """Mientras efectúas un ataque principal, si no estás situado en el arco de fuego del defensor, puedes volver a tirar hasta 2 dados de ataque."""
        "Genesis Red":
        ...
        "Green Squadron Expert":
           display_name: """Experto del Escuadrón Verde"""
        ...
        "Han Solo (Resistance)":
           display_name: """Han Solo"""
           text: """<strong>Preparación:</strong> Puedes ser colocado en cualquier lugar de la zona de juego que esté más allá de alcance 3 de las naves enemigas."""
        "Heff Tobber":
        ...
        "Jaycris Tubbs":
           ...
           text: """Después de que ejecutes completamente una maniobra azul, puedes elegir una nave aliada que tengas a alcance 0-1. Si lo haces, esa nave retira 1 ficha de Tensión."""
        "Jedi Knight":
           display_name: """Caballero jedi"""
           text: """<i class = flavor_text>Cuando las Guerras Clon dieron comienzo, los caballeros jedi se sumaron a la causa por la preservación de la República tomando el mando de legiones de soldados clon y liderándolos en batalla.</i>"""
        ...
        "Jessika Pava":
           ...
           text: """Mientras te defiendes o efectúas un ataque, puedes gastar 1 %CHARGE% o 1 %CHARGE% no recurrente de la mejora %ASTROMECH% que tengas equipada para volver a tirar hasta 1 de tus dados por cada otra nave aliada que tengas a alcance 0-1."""
        "Joph Seastriker":
        ...
        "Kare Kun":
           ...
           text: """Mientras realizas una acción %BOOST%, puedes utilizar la plantilla [1 %TURNLEFT%] o [1 %TURNRIGHT%] en vez de una de las plantillas normales para esta acción."""
        "Kashyyyk Defender":
        ...
        "Kylo Ren":
           ...
           text: """Después de que te defiendas, puedes gastar 1 %FORCE% para asignar el estado <strong>Yo te mostraré el Lado Oscuro</strong> al atacante."""
        "L3-37":
           display_name: """L3-37"""
           text: """Si no estás protegido por escudos, reduce la dificultad de tus maniobras de inclinación (%BANKLEFT% y %BANKRIGHT%)."""
        "L3-37 (Escape Craft)":
           display_name: """L3-37 (Nave de escape)"""
        ...
        "Lando Calrissian (Scum)":
           display_name: """Lando Calrissian (Escoria)"""
        ...
        "Lando Calrissian (Scum) (Escape Craft)":
           display_name: """Lando Calrissian (Escoria) (Nave de escape)"""
        ...
        "Luminara Unduli":
           ...
           text: """Mientras una nave aliada que tienes a alcance 0-2 se defiende, si esa nave no está en el %BULLSEYEARC% del atacante, puedes gastar 1 %FORCE%. Si lo haces, cambia 1 resultado %CRIT% por un resultado %HIT% o 1 resultado %HIT% por un resultado %FOCUS%."""
        ...
        "Major Stridan":
           display_name: """Mayor Stridan"""
           text: """Mientras realizas una coordinación o resuelves el efecto de una de tus mejoras, puedes considerar a las naves aliadas que tengas a alcance 2-3 como si las tuvieras a alcance 0 o a alcance 1."""
        "Major Vermeil":
        ...
        "Mining Guild Sentry":
           display_name: """Centinela del Gremio Minero"""
           text: """<i class = flavor_text>Como parte de su acuerdo con el Imperio, el Gremio Minero recibe cazas TIE/ln modificados para la protección de sus operaciones. A estos cazas se les han retirado varios paneles solares de sus estabilizadores para mejorar la visibilidad, y poseen sistemas de soporte vital más completos para mayor confort de sus pilotos corporativos.</i>"""
        "Mining Guild Surveyor":
           display_name: """Inspector del Gremio Minero"""
           text: """<i class = flavor_text>Con los proyectos de construcción imperiales consumiendo materias primas a un ritmo sin precedentes, el Gremio Minero explota implacablemente los yacimientos de doonio recién descubiertos en mundos como Batonn, Lothal y Umbara.</i>"""
        "Miranda Doni":
        ...
        "Obi-Wan Kenobi":
           ...
           text: """Después de que una nave aliada que tengas a alcance 0-2 gaste una ficha de Concentración, puedes gastar 1 %FORCE%. Si lo haces, esa nave recibe 1 ficha de Concentración."""
        ...
        "Omega Squadron Expert":
           display_name: """Experto del Escuadrón Omega"""
           text: """<i class = flavor_text>El TIE/sf es un caza estelar muy versátil provisto de armamento especializado y sistemas experimentales para operaciones de largo alcance llevadas a cabo por las Fuerzas Especiales de la Primera Orden.</i>"""
        "Omicron Group Pilot":
        ...
        "Overseer Yushyn":
           ...
           text: """Antes de que una nave aliada que tengas a alcance 1 vaya a recibir una ficha de Desarme, si esa nave no está bajo tensión, puedes gastar 1 %CHARGE%. Si lo haces, esa nave recibe 1 ficha de Tensión en vez de la ficha de Desarme."""
        "Padmé Amidala":
        ...
        "Pammich Nerro Goode":
           ...
           text: """Mientras tienes 2 o menos fichas de Tensión, puedes ejecutar maniobras rojas incluso aunque estés bajo tensión."""
        "Partisan Renegade":
        ...
        "Plo Koon":
           ...
           text: """Al comienzo de la fase de Enfrentamiento, puedes gastar 1 %FORCE% y elegir otra nave aliada que tengas a alcance 0-2. Si lo haces, puedes transferir 1 ficha verde a esa nave o transferir una ficha naranja de esa nave a ti mismo."""
        "Plo Koon (Delta-7b)":
           display_name: """Plo Koon"""
           text: """Al comienzo de la fase de Enfrentamiento, puedes gastar 1 %FORCE% y elegir otra nave aliada que tengas a alcance 0-2. Si lo haces, puedes transferir 1 ficha verde a esa nave o transferir una ficha naranja de esa nave a ti mismo."""
        "Poe Dameron":
           display_name: """Poe Dameron"""
           text: """Después de que realices una acción, puedes gastar 1 %CHARGE% para realizar una acción blanca, considerándola como si fuera roja."""
        "Prince Xizor":
        ...
        "Red Squadron Expert":
           ...
           text: """<i class = flavor_text>Aunque el grueso del Cuerpo de Cazas Estelares de la Resistencia está compuesto por jóvenes voluntarios de la Nueva República, sus filas se ven reforzadas por veteranos de la Guerra Civil Galáctica decididos a terminar lo que empezaron hace décadas.</i>"""
        ...
        "Resistance Sympathizer":
           display_name: """Simpatizante de la Resistencia"""
           text: """<i class = flavor_text>Tras presenciar el cataclismo de Hosnian, algunos viajeros espaciales ayudaron de buen grado a la Resistencia con cualquier nave que tuvieran a su disposición.</i>"""
        "Rexler Brath":
        ...
        "Rey":
           display_name: """Rey"""
           text: """Mientras te defiendes o efectúas un ataque, si la nave enemiga está situada en tu %FRONTARC%, puedes gastar 1 %FORCE% para cambiar 1 de tus resultados de cara vacía por un resultado %EVADE% o %HIT%."""
        "Rho Squadron Pilot":
        ...
        "Saesee Tiin":
           ...
           text: """Después de que una nave aliada que tengas a alcance 0-2 revele su selector, puedes gastar 1 %FORCE%. Si lo haces, establece en su selector otra maniobra que tenga la misma velocidad y dificultad que la original."""
        ...
        "Separatist Bomber":
           display_name: """Bombardero separatista"""
           text: """<i class = flavor_text>Los ejércitos de droides de la Alianza Separatista son insensibles al sufrimiento de los civiles y no hacen ningún esfuerzo por limitar los daños colaterales.</i>"""
        "Separatist Drone":
           display_name: """Dron separatista"""
           text: """<i class = flavor_text>A medida que las Guerras Clon se recrudecen, la Alianza Separatista sigue desarrollando la tecnología de cazas estelares droide, así como la de los droides tácticos que los coordinan.</i>"""
        "Serissu":
        ...
        "Sienar-Jaemus Engineer":
           display_name: """Ingeniero de Sienar-Jaemus"""
           text: """<i class = flavor_text>Concebido por Sistemas de Flota Sienar-Jaemus como un sucesor del elogiado Defensor TIE, el Silenciador TIE/vn incorpora tecnologías de última generación desarrolladas en instalaciones de investigación ocultas en las Regiones Desconocidas.</i>"""
        "Sigma Squadron Ace":
        ...
        "TN-3465":
           ...
           text: """Mientras otra nave aliada efectúa un ataque, si estás a alcance 0-1 del defensor, puedes sufrir 1 de daño %CRIT% para cambiar 1 de los resultados del atacante por un resultado %CRIT%."""
        "Tala Squadron Pilot":
        ...
        "Tansarii Point Veteran":
           display_name: """Veterano de Punto Tansarii"""
           text: """<i class = flavor_text>La derrota de Talonbane Cobra, el as del Sol negro, a manos de los contrabandistas Car’das cambió el curso de la batalla de la estación Punto Tansarii. A los supervivientes de ese enfrentamiento se les respeta en todo el sector.</i> """
        "Techno Union Bomber":
           display_name: """Bombardero de la Tecno Unión"""
           text: """<i class = flavor_text>Armeros Baktoides concibió el Hiena como un vehículo de ataque compatible con las tácticas de enjambre utilizadas por los Buitre.</i>"""
        "Tel Trevura":
        ...
        "Trade Federation Drone":
           display_name: """Dron de la Federación de Comercio"""
           text: """<i class = flavor_text>La Federación de Comercio desplegó incontables droides Buitre en la batalla de Naboo, y continuó utilizando estos cazas estelares tan baratos en las Guerras Clon.</i>"""
        "Trandoshan Slaver":
        ...
        "Wat Tambor":
           ...
           text: """Mientras efectúas un ataque principal, puedes volver a tirar 1 dado de ataque por cada nave aliada calculando que esté situada a alcance 1 del defensor."""
        "Wedge Antilles":
        ...
        '"Avenger"':
           display_name: """Vengador"""
           text: """Después de que otra nave aliada sea destruida, puedes realizar una acción, incluso aunque estés bajo tensión."""
        '"Axe"':
           display_name: """“Axe”"""
           text: """Después de que te defiendas o efectúes un ataque, puedes elegir una nave aliada que tengas a alcance 1-2 en tu %LEFTARC%  o %RIGHTARC%. Si lo haces, transfiere 1 ficha verde a esa nave."""
        '"Backdraft"':
           display_name: """Llamarada"""
           text: """Mientras efectúas un ataque principal %SINGLETURRETARC%, si el defensor está en tu %REARARC%, tira 1 dado adicional."""
        '"Blackout"':
           display_name: """“Apagón”"""
        ...
        '"Jag"':
           display_name: """“Jag”"""
           text: """Después de que una nave aliada que tengas a alcance 1-2 en tu %LEFTARC%  o %RIGHTARC% se defienda, puedes obtener un Blanco fijado sobre el atacante."""
        '"Kickback"':
           display_name: """“Kickback”"""
           text: """Después de que realices una acción %BARRELROLL%, puedes realizar una acción %LOCK% roja."""
        '"Leebo"':
           display_name: """“Leebo”"""
        ...
        '"Midnight"':
           display_name: """“Medianoche”"""
           text: """Mientras te defiendes o efectúas un ataque, si tienes a la nave enemiga fijada como blanco, los dados de esa nave no se pueden modificar."""
        '"Muse"':
           display_name: """Musa"""
           text: """Al comienzo de la fase de Enfrentamiento, puedes elegir una nave aliada que tengas a alcance 0-1. Si lo haces, esa nave retira 1 ficha de Tensión."""
        '"Night Beast"':
        ...
        '"Null"':
           display_name: """Nulo"""
           text: """Mientras no estés dañado, tu valor de Iniciativa se considera que es 7."""
        '"Odd Ball"':
        ...
        '"Quickdraw"':
           display_name: """Centella"""
           text: """Después de que pierdas un escudo, puedes gastar 1 %CHARGE%. Si lo haces, puedes efectuar un ataque principal adicional."""
        '"Recoil"':
           display_name: """“Retroceso”"""
           text: """Mientras estás bajo tensión, las naves enemigas que tengas a alcance 0-1 y estén en tu %FRONTARC% puedes considerarlas como si estuvieran en tu %BULLSEYEARC%."""
        '"Redline"':
        ...
        '"Scorch"':
           ...
           text: """Mientras efectúas un ataque principal, si no estás bajo tensión, puedes recibir 1 ficha de Tensión para tirar 1 dado de ataque adicional."""
        '"Scourge" Skutu':
        ...
        '"Sinker"':
           display_name: """“Sinker”"""
           text: """Mientras una nave aliada que tienes a alcance 1-2 en tu %LEFTARC% o %RIGHTARC% efectúa un ataque principal, esa nave puede volver a tirar 1 dado de ataque."""
        '"Static"':
           display_name: """“Estática”"""
           text: """Mientras efectúas un ataque principal, puedes gastar tu Blanco fijado sobre el defensor y una ficha de Concentración para cambiar todos tus resultados por resultados %CRIT%."""
        '"Swoop"':
           display_name: """“Swoop”"""
           text: """Después de que una nave aliada pequeña o mediana ejecute completamente una maniobra de velocidad 3-4, si esa nave está situada a alcance 0-1 de ti, puede realizar una acción %BOOST% roja."""
        '"Tucker"':
           display_name: """“Tucker”"""
        ...
        '"Wolffe"':
           display_name: """“Wolffe”"""
           text: """Mientras efectúas un ataque principal %FRONTARC%, puedes gastar 1 %CHARGE% para volver a tirar 1 dado de ataque. %LINEBREAK%Mientras efectúas un ataque principal %REARARC%, puedes recuperar 1 %CHARGE% para tirar 1 dado de ataque adicional."""
        '"Zeb" Orrelios':
    ...
    upgrade_translations =
        ...
        "Black One":
           display_name: """Negro Uno"""
           text: """Después de que realices una acción %SLAM%, pierdes 1 %CHARGE%. Luego puedes recibir 1 ficha de Iones para retirar 1 ficha de Desarme.%LINEBREAK%Si tu %CHARGE% está inactiva, no puedes realizar la acción %SLAM%."""
        "Dauntless":
        ...
        "Scimitar":
           display_name: """Cimitarra"""
           text: """<strong>Preparación:</strong> Después del paso de "Desplegar las fuerzas", puedes camuflarte.%LINEBREAK%Después de que desactives el camuflaje, puedes elegir una nave enemiga situada en tu %BULLSEYEARC%. Si lo haces, esa nave recibe 1 ficha de Interferencia."""
        "Shadow Caster":
        ...
        "Advanced Optics":
           ...
           text: """Mientras efectúas un ataque, puedes gastar 1 ficha de Concentración para cambiar 1 de tus resultados de cara vacía por un resultado %HIT%."""
        "Advanced SLAM":
        ...
        "BB Astromech":
           ...
           text: """Durante la Fase de Sistemas, puedes gastar 1 %CHARGE% para realizar una acción de %BARRELROLL%. %LINEBREAK% <i>Errata (desde la referencia de reglas 1.4.2): Cambiada la temporización del efecto a la Fase de Sistemas</i>"""
        "BB-8":
           display_name: """BB-8"""
           text: """Durante la Fase de Sistemas, puedes gastar 1 %CHARGE% para realizar una acción de %BARRELROLL% o %BOOST%. %LINEBREAK% <i>Errata (desde la referencia de reglas 1.4.2): Cambiada la temporización del efecto a la Fase de Sistemas</i>"""
        "BT-1":
           display_name: """BT-1"""
        ...
        "Battle Meditation":
           display_name: """Meditación de batalla"""
           text: """No puedes coordinar naves limitadas.%LINEBREAK% Mientras realizas una acción %COORDINATE% violeta, puedes coordinar 1 nave aliada que no sea limitada adicional del mismo tipo. Ambas naves deben realizar la misma acción."""
        "Baze Malbus":
        ...
        "Biohexacrypt Codes":
           display_name: """Códigos biohexaencriptados"""
           text: """Mientras realizas una coordinación o interferencia, si tienes alguna nave fijada como blanco, puedes gastar ese Blanco fijado para elegir dicha nave, ignorando las restricciones de alcance."""
        "Bistan":
           display_name: """Bistan"""
        ...
        "Brilliant Evasion":
           display_name: """Evasión impecable"""
           text: """Mientras te defiendes, si no estás situado en el %BULLSEYEARC% del atacante, puedes gastar 1 %FORCE% para cambiar 2 de tus resultados %FOCUS% por resultados %EVADE%."""
        "C-3PO":
           display_name: """C-3PO"""
        ...
        "Calibrated Laser Targeting":
           display_name: """Sistema de puntería láser calibrado"""
           text: """Mientras efectúas un ataque principal, si el defensor está situado en tu %BULLSEYEARC%, añade 1 resultado %FOCUS%."""
        "Captain Phasma":
           display_name: """Captain Phasma"""
           text: """Al final de la fase de Enfrentamiento, toda nave enemiga que tengas a alcance 0-1 y que no esté bajo tensión recibe 1 ficha de Tensión."""
        "Cassian Andor":
           display_name: """Cassian Andor"""
        ...
        "Chewbacca (Scum)":
           display_name: """Chewbacca"""
           text: """Al comienzo de la fase Final, puedes gastar 1 ficha de Concentración para reparar 1 de tus cartas de Daño boca arriba."""
        "Chewbacca (Resistance)":
           display_name: """Chewbacca"""
        ...
        "Dedicated":
           display_name: """Entrega absoluta"""
           text: """Mientras otra nave aliada que tienes en tu %LEFTARC% o %RIGHTARC% a alcance 0-2 defends, si esa nave es limitada o posee la mejora <strong>Entrega absoluta</strong> y tú no estás bajo sobresfuerzo, puedes recibir 1 ficha de Sobresfuerzo. Si lo haces, el defensor vuelve a tirar 1 de sus resultados de cara vacía.%LINEBREAK%<i>Errata (desde las reglas de referencia 1.4): Se eliminó la restricción No limitada y se agregó la restricción Clon</i>"""
        "Delayed Fuses":
           display_name: """Espoletas retardadas"""
           text: """Después de que sueltes, lances o coloques una bomba o mina, puedes colocar 1 indicador de Espoleta sobre ese dispositivo."""
        "Delta-7B":
           display_name: """Delta-7B"""
           text: """<i class = flavor_text>El Delta-7B fue diseñado como una variante más pesada del interceptor clase Delta-7 Duende del Éter, y es fácilmente identificable por el cambio en la posición del droide astromecánico. Muchos generales jedi prefieren esta nave por su mayor resistencia y potencia de fuego.</i>"""
        "Dengar":
           display_name: """Dengar"""
        ...
        "Diamond-Boron Missiles":
           ...
           text: """<strong>Ataque  (%LOCK%):</strong> Gasta 1 %CHARGE%. Después de que este ataque impacte, puedes gastar 1 %CHARGE%. Si lo haces, toda nave a alcance 0-1 del defensor con un valor de Agilidad igual o inferior al del defensor tira 1 dado de ataque y sufre 1 de daño %HIT%/%CRIT% por cada resultado equivalente."""
        "Director Krennic":
        ...
        "Energy-Shell Charges":
           ...
           text: """<strong>Ataque (%CALCULATE%):</strong> Gasta  1 %CHARGE%.Mientras efectúas este ataque, puedes gastar 1 ficha de Cálculos para cambiar 1 resultado %FOCUS% por un resultado %CRIT%.%LINEBREAK%<strong>Acción</strong>: Recarga esta carta."""
        "Engine Upgrade":
        ...
        "Ensnare":
           display_name: """Apresamiento"""
           text: """Al final de la fase de Activación, si estás atrapado en un campo de tracción, puedes elegir 1 nave que tengas en tu arco %SINGLETURRETARC% a alcance 0-1. Transfiere 1 ficha de Campo de tracción a esa nave."""
        "Expert Handling":
        ...
        "Fanatical":
           ...
           text: """Mientras efectúas un ataque principal, si no estás protegido por escudos, puedes cambiar 1 resultado %FOCUS% por un resultado %HIT%."""
        "Fearless":
           display_name: """Intrépido"""
        ...
        "Ferrosphere Paint":
           display_name: """Pintura ferrosférica"""
           text: """Después de que una nave enemiga te fije como blanco, si no estás situado en el %BULLSEYEARC%, de esa nave, ésta recibe 1 ficha de Tensión a no ser que deje de fijarte como blanco.%LINEBREAK%<i>Errata (desde las reglas de referencia 1.4): Habilidad ajustada para permitir el contrajuego</i>"""
        "Fifth Brother":
        ...
        "Finn":
           display_name: """Finn"""
           text: """Mientras te defiendes o efectúas un ataque principal, si la nave enemiga está situada en tu %FRONTARC%, puedes añadir 1 resultado de cara vacía a tu tirada (este dado puede ser vuelto a tirar o modificado de cualquier otra manera)."""
        "Fire-Control System":
        ...
        "General Grievous":
           display_name: """General Grievous"""
           text: """Mientras te defiendes, después del paso de "Neutralizar los resultados", si hay 2 o más resultados  %HIT%/%CRIT%, puedes gastar 1 %CHARGE% para anular 1 resultado %HIT% o %CRIT%. %LINEBREAK%Después de que una nave aliada sea destruida, recuperas 1 %CHARGE%."""
        "General Hux":
           display_name: """General Hux"""
           text: """Mientras realizas una acción %COORDINATE% blanca, puedes considerarla como si fuera roja. Si lo haces, puedes coordinar hasta 2 naves adicionales del mismo tipo de nave, y cada nave que coordines debe realizar la misma acción, considerándola como si fuera roja."""
        "Grand Inquisitor":
           display_name: """Gran Inquisidor"""
        ...
        "Han Solo (Resistance)":
           display_name: """Han Solo"""
           text: """Después de que realices una acción %EVADE%, recibes tantas fichas de Evasión adicionales como la cantidad de naves enemigas que tienes a alcance 0-1."""
        "Hate":
           display_name: """Odio"""
           text: """Después de que sufras 1 o más de daño, recuperas esa misma cantidad de %FORCE%."""
        "Heavy Laser Cannon":
        ...
        "Heroic":
           display_name: """Audaz"""
           text: """Mientras te defiendes o efectúas un ataque, si sólo tienes resultados de cara vacía y tienes 2 o más resultados, puedes volver a tirar cualquier cantidad de tus dados."""
        "Homing Missiles":
        ...
        "Impervium Plating":
           display_name: """Blindaje de impenetranio"""
           text: """Antes de que vayas a recibir una carta de <strong>Daño Nave</strong> boca arriba, puedes gastar 1 %CHARGE% para descartarla en vez de recibirla."""
        "Inertial Dampeners":
        ...
        "Integrated S-Foils":
           display_name: """Alas móviles integradas"""
           text: """<strong>Cerrada: </strong><i>%BARRELROLL%, %FOCUS% <i class="xwing-miniatures-font xwing-miniatures-font-linked"></i> <r>%BARRELROLL%</r></i>%LINEBREAK% Mientras efectúas un ataque principal, si el defensor no está situado en tu %BULLSEYEARC%, tira 1 dado de ataque menos. %LINEBREAK% Antes de que te actives, puedes darle la vuelta a esta carta. %LINEBREAK% <b>Abierta:</b> Antes de que te actives, puedes darle la vuelta a esta carta."""
        "Intimidation":
        ...
        "Kraken":
           display_name: """Kraken"""
           text: """Durante la fase Final, puedes elegir hasta 3 naves aliadas que tengas a alcance 0-3. Si lo haces, cada una de esas naves no retira 1 ficha de Cálculos."""
        "Kylo Ren":
           display_name: """Kylo Ren"""
           text: """<strong>Acción:</strong> Elige 1 nave enemiga que tengas a alcance 1-3. Si lo haces, gasta 1 %FORCE% para asignar el estado <strong>Yo te mostraré el Lado Oscuro</strong> a esa nave."""
        "L3-37":
           display_name: """L3-37"""
        ...
        "Kylo Ren":
           display_name: """Kylo Ren"""
           text: """<strong>Action:</strong> Elige 1 nave enemiga que tengas a alcance 1-3. Si lo haces, gasta 1 %FORCE% para asignar el estado <strong>Yo te mostraré el Lado Oscuro</strong> a esa nave."""
        "Landing Struts":
           display_name: """Puntales de aterrizaje"""
           text: """Cerrada:%LINEBREAK%<strong>Preparación:</strong> Equipa esta carta con este lado boca arriba. %LINEBREAK% Mientras ejecutas una maniobra, si te solapas con un asteroide o con desechos espaciales y hay 1 o menos otras naves aliadas a alcance 0 de ese obstáculo, puedes darle la vuelta a esta carta. Si lo haces, no sufres los efectos de solapar el asteroide o desechos espaciales. %LINEBREAK% Abierta:%LINEBREAK% Ignoras los obstáculos que tienes a alcance 0. No puedes ejecutar la acción %BARRELROLL%. Después de que reveles tu selector, si la maniobra revelada es distinta a [2 %STRAIGHT%] y estás a alcance 0 de un asteroide o desechos espaciales, omite tu paso de "Ejecutar maniobra" y retira 1 ficha de Tensión. Si la maniobra revelada es hacia la izquierda o hacia la derecha, gira tu nave 90º hacia esa dirección. Después de que ejecutes una maniobra, dale la vuelta a esta carta.%LINEBREAK%<i>Errata (ya que las reglas hacen referencia a 1.4): texto actualizado para que funcione según lo previsto</i>"""
        "Lando Calrissian":
           display_name: """Lando Calrissian"""
        ...
        "Pattern Analyzer":
           ...
           text: """Mientras ejecutas completamente una maniobra roja, antes del paso de "Comprobar la dificultad", puedes realizar 1 acción."""
        "Perceptive Copilot":
        ...
        "Primed Thrusters":
           ...
           text: """Mientras tengas 2 o menos fichas de Tensión, puedes realizar acciones %BARRELROLL% y %BOOST% incluso aunque estés bajo tensión."""
        "Proton Bombs":
        ...
        "R2-HA":
           display_name: """R2-HA"""
           text: """Mientras te defiendes, puedes gastar tu Blanco fijado sobre el atacante para volver a tirar cualquier cantidad de tus dados de defensa."""
        "R3 Astromech":
        ...
        "R4-P17":
           display_name: """R4-P17"""
           text: """Después de que ejecutes completamente una maniobra roja, puedes gastar 1 %CHARGE% para realizar una acción, incluso aunque estés bajo tensión."""
        "R4-P44":
           display_name: """R4-P44"""
           text: """Después de que ejecutes completamente una maniobra roja, si tienes alguna nave enemiga situada en tu %BULLSEYEARC%, recibes 1 ficha de Cálculos."""
        "R5 Astromech":
        ...
        "R5-X3":
           display_name: """R5-X3"""
           text: """Antes de que te actives o intervengas, puedes gastar 1 %CHARGE% para ignorar los obstáculos hasta el final de esta fase."""
        "Rey":
           display_name: """Rey"""
           text: """Mientras te defiendes o efectúas un ataque, si la nave enemiga está situada en tu %SINGLETURRETARC%, puedes gastar 1 %FORCE% para cambiar 1 de tus resultados de cara vacía por un resultado %EVADE% o %HIT%."""
        "Rey's Millennium Falcon":
           display_name: """Rey's Millennium Falcon"""
           text: """Si tienes 2 o menos fichas de Tensión, puedes ejecutar maniobras de giro de Segnor [%SLOOPLEFT% o %SLOOPRIGHT%] rojas y realizar acciones %BOOST% y %ROTATEARC% incluso aunque estés bajo tensión."""
        "Rigged Cargo Chute":
        ...
        "Rose Tico":
           ...
           text: """Mientras te defiendes o efectúas un ataque, puedes gastar 1 de tus resultados para obtener un Blanco fijado sobre la nave enemiga."""
        "Ruthless":
           display_name: """Cruel"""
        ...
        "Selfless (BoY)":
           display_name: """Autosacrificio"""
           text: """Mientras otra nave aliada que tienes a alcance 0-1 se defiende, antes del paso de Neutralizar los resultados, si estás en el arco de ataque, puedes sufrir 1 de daño %CRIT% para anular 1 resultado %CRIT%."""
        "Sense":
           display_name: """Sentir"""
        ...
        "Seventh Fleet Gunner":
           display_name: """Artillero de la Séptima Flota"""
           text: """Mientras otra nave aliada efectúa un ataque principal, si el defensor está situado en tu arco de fuego, puedes gastar 1 %CHARGE%. Si lo haces, el atacante tira 1 dado adicional, hasta un máximo de 4. Durante la fase de Sistemas, puedes recibir 1 ficha de Desarme para recuperar 1 %CHARGE%."""
        "Seventh Sister":
           display_name: """Séptima Hermana"""
        ...
        "Spare Parts Canisters":
           ...
           text: """<strong>Acción:</strong> Gasta  1 %CHARGE% para recuperar 1 carga sobre una de tus mejoras %ASTROMECH% equipadas. %LINEBREAK%<strong>Acción:</strong> Gasta  1 %CHARGE% para soltar 1 ficha de Piezas de recambio y luego interrumpe todos los Blancos fijados asignados a ti."""
        "Special Forces Gunner":
           display_name: """Artillero de las Fuerzas Especiales"""
           text: """Mientras efectúas un ataque principal %FRONTARC%, si tu %SINGLETURRETARC% está situado en tu %FRONTARC%, puedes tirar 1 dado de ataque adicional.%LINEBREAK%Después de que efectúes un ataque principal %FRONTARC%, si tu %SINGLETURRETARC% está situado en tu %REARARC%, puedes efectuar un ataque principal %SINGLETURRETARC% adicional."""
        "Squad Leader":
        ...
        "Supreme Leader Snoke":
           ...
           text: """Durante la fase de Sistemas, puedes elegir cualquier cantidad de naves enemigas que tengas más allá de alcance 1. Si lo haces, gasta esa misma cantidad de %FORCE% para poner boca arriba todos los selectores de las naves elegidas."""
        "Swarm Tactics":
        ...
        "Synchronized Console":
           display_name: """Panel de mandos sincronizado"""
           text: """Después de que efectúes un ataque, puedes elegir una nave aliada que tengas a alcance 1 o una nave aliada con la mejora <strong>Panel de mandos sincronizado</strong> que tengas a alcance 1-3 y gastar un Blanco fijado que tengas sobre el defensor. Si lo haces, la nave aliada que elegiste puede obtener un Blanco fijado sobre el defensor."""
        "TA-175":
           display_name: """TA-175"""
           text: """Después de que una nave aliada que tengas a alcance 0-3 con %CALCULATE% en su barra de acciones sea destruida, toda nave aliada que tengas a alcance 0-3 con %CALCULATE% en su barra de acciones recibe 1 ficha de Cálculos."""
        "TV-94":
           display_name: """TV-94"""
           text: """Mientras una nave aliada que tienes a alcance 0-3 efectúa un ataque principal contra un defensor situado en su %BULLSEYEARC%, si hay 2 o menos dados de ataque, la nave aliada puede gastar 1 ficha de Cálculos para añadir 1 resultado %HIT%."""
        "Tactical Officer":
        ...
        "Treacherous":
           display_name: """Traicionero"""
           text: """Mientras te defiendes, puedes elegir una nave que obstruya el ataque y gastar 1 %CHARGE%. Si lo haces, anula 1 resultado %HIT% o %CRIT%, y la nave elegida recibe 1 ficha de Sobresfuerzo.Después de que una nave que tengas a alcance 0-3 sea destruida, recuperas 1 %CHARGE%."""
        "Trick Shot":
